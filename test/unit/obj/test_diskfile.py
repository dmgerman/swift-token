...
name|'mock_func'
op|'='
string|"'swift.obj.diskfile.DiskFileManager.get_dev_path'"
newline|'\n'
name|'with'
name|'mock'
op|'.'
...
op|':'
newline|'\n'
comment|'# get_ondisk_files does not tolerate a stray .meta file'
nl|'\n'
nl|'\n'
indent|'        '
name|'class_under_test'
...
nl|'\n'
nl|'\n'
comment|'# TODO these remaining scenarios exhibit different'
nl|'\n'
comment|'# behavior than the legacy replication DiskFileManager'
nl|'\n'
comment|'# behavior...'
nl|'\n'
nl|'\n'
...
name|'msg'
op|'='
string|"'Expected DiskFileError for filename %s'"
op|'%'
name|'fname'
newline|'\n'
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|test_is_obsolete
dedent|''
dedent|''
dedent|''
name|'def'
name|'test_is_obsolete'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
string|"'%s should not be obsolete w.r.t. %s'"
nl|'\n'
op|'%'
op|'('
name|'f_1'
...
op|','
nl|'\n'
string|"'%s should not be w.r.t. %s'"
nl|'\n'
op|'%'
op|'('
name|'f_1'
...
op|'{'
nl|'\n'
comment|'# TODO: differs from repl DiskFileManager which *will*'
nl|'\n'
comment|'# return meta timestamp when only meta and ts on disk'
nl|'\n'
string|"'9373a92d072897b136b3fc06595b4abc'"
op|':'
name|'ts1'
...
op|','
nl|'\n'
string|"'9373a92d072897b136b3fc06595b8456'"
op|':'
op|'['
nl|'\n'
string|"'junk_file'"
...
op|','
nl|'\n'
string|"'9373a92d072897b136b3fc06595b9456'"
op|':'
op|'['
nl|'\n'
name|'ts1'
...
op|','
nl|'\n'
string|"'9373a92d072897b136b3fc06595bb456'"
op|':'
op|'['
nl|'\n'
name|'ts1'
...
op|':'
newline|'\n'
comment|"# EC policy does tolerate only .meta's in dir when cleaning up"
nl|'\n'
indent|'                '
name|'expected'
op|'='
...
op|':'
newline|'\n'
comment|"# the get_ondisk_files contract validation doesn't allow a"
nl|'\n'
comment|'# directory with only .meta files'
nl|'\n'
indent|'                '
name|'expected'
op|'='
...
op|':'
newline|'\n'
comment|'# EC will clean up old .ts despite a .meta'
nl|'\n'
indent|'                '
name|'expected'
op|'='
...
op|':'
newline|'\n'
comment|'# the .ts gets reclaimed up despite failed .data delete'
nl|'\n'
indent|'                '
name|'expected'
op|'='
...
op|':'
newline|'\n'
comment|"# the .ts isn't reclaimed because there were two files in dir"
nl|'\n'
indent|'                '
name|'expected'
op|'='
...
op|'{'
nl|'\n'
comment|"# repl is broken, it doesn't use self.reclaim_age"
nl|'\n'
name|'REPL_POLICY'
op|':'
name|'tombstone_hash'
...
op|')'
newline|'\n'
comment|'# ... but is hashed as "empty"'
nl|'\n'
name|'expected'
op|'='
op|'{'
