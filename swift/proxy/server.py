...
name|'Exception'
op|'('
string|"'Could not load object segment %s: %s'"
op|'%'
op|'('
name|'path'
op|','
...
name|'exception'
op|'('
string|"'ERROR: While processing '"
nl|'\n'
string|"'manifest /%s/%s/%s %s'"
op|'%'
op|'('
name|'self'
op|'.'
...
nl|'\n'
comment|'# webob resp for the headers but return an empty generator'
nl|'\n'
...
op|'('
nl|'\n'
string|"'Object PUT exceptions during send, %s/%s '"
nl|'\n'
string|"'required connections, transaction %s'"
op|'%'
nl|'\n'
op|'('
name|'len'
