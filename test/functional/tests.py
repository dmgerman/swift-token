...
op|','
nl|'\n'
string|"'www-authenticate not found in %s'"
op|'%'
name|'resp_headers'
op|')'
newline|'\n'
...
op|':'
newline|'\n'
comment|'# there is no such source container'
nl|'\n'
comment|'# and foreign user can have no permission to read it'
nl|'\n'
indent|'                    '
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# there is no such object'
nl|'\n'
comment|'# and foreign user can have no permission to read it'
nl|'\n'
indent|'                    '
...
op|':'
newline|'\n'
comment|'# To avoid the bug 1453807 on fast-post, make a new manifest'
nl|'\n'
comment|'# for post test.'
nl|'\n'
indent|'        '
name|'file_item'
op|'='
...
name|'False'
newline|'\n'
comment|'# We have to lie here that versioning is enabled. We actually'
nl|'\n'
comment|"# don't know, but it does not matter. We know these tests cannot"
nl|'\n'
comment|'# run without multiple policies present. If multiple policies are'
nl|'\n'
comment|"# present, we won't be setting this field to any value, so it"
nl|'\n'
comment|'# should all still work.'
nl|'\n'
name|'cls'
op|'.'
name|'versioning_enabled'
