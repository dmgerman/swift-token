...
newline|'\n'
nl|'\n'
DECL|member|handle_get_accounts
dedent|''
name|'def'
name|'handle_get_accounts'
op|'('
...
name|'Exception'
op|'('
string|"'Could not create account on the Swift cluster: '"
nl|'\n'
string|"'%s %s %s'"
op|'%'
op|'('
...
name|'Exception'
op|'('
string|"'Could not create .clusters object: %s %s'"
op|'%'
nl|'\n'
op|'('
name|'path'
...
op|')'
newline|'\n'
comment|'# Make sure the account has no users.'
nl|'\n'
dedent|''
name|'marker'
op|'='
...
op|']'
newline|'\n'
comment|'# Obtain the listing of clusters the account is on.'
nl|'\n'
dedent|''
name|'path'
op|'='
...
op|')'
newline|'\n'
comment|'# Delete the .clusters object itself.'
nl|'\n'
dedent|''
dedent|''
name|'path'
...
op|')'
newline|'\n'
comment|'# Obtain the account id mapping for the account.'
nl|'\n'
name|'path'
op|'='
name|'quote'
...
name|'error'
op|'('
string|"'Could not delete account id '"
nl|'\n'
string|"'mapping: %s %s'"
op|'%'
op|'('
...
name|'error'
op|'('
string|"'Could not delete account marked: '"
nl|'\n'
string|"'%s %s'"
op|'%'
op|'('
...
op|')'
newline|'\n'
comment|'# Get the cluster url information'
nl|'\n'
dedent|''
dedent|''
name|'path'
...
name|'Exception'
op|'('
string|"'Could not obtain clusters info: %s %s'"
op|'%'
nl|'\n'
op|'('
name|'path'
