...
op|')'
newline|'\n'
comment|'# We would change expectations here, but in this test no handoffs'
nl|'\n'
comment|'# changed at all.'
nl|'\n'
name|'part'
op|','
name|'devs'
...
nl|'\n'
comment|'# The long string of handoff nodes for the partition were the same for'
nl|'\n'
comment|'# the first 20, which is pretty good.'
nl|'\n'
name|'exp_handoffs'
op|'['
number|'20'
...
newline|'\n'
nl|'\n'
comment|'# Just a few of the first handoffs changed'
nl|'\n'
name|'exp_first_handoffs'
op|'['
number|'3'
...
newline|'\n'
nl|'\n'
comment|'# Lots of first handoffs changed, but 30 of 256 is still just 11.72%.'
nl|'\n'
name|'exp_first_handoffs'
op|'['
number|'1'
