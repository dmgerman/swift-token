...
newline|'\n'
nl|'\n'
DECL|member|test_ignores_status_file
dedent|''
name|'def'
name|'test_ignores_status_file'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Following fd86d5a, the auditor will leave status files on each device'
nl|'\n'
comment|'# until an audit can complete. The reconstructor should ignore these'
nl|'\n'
nl|'\n'
indent|'        '
op|'@'
