...
nl|'\n'
comment|'# submanifest referencing 50 MiB total, but first_byte falls in the'
nl|'\n'
comment|'# 51st MiB, then we can avoid fetching the first submanifest.'
nl|'\n'
comment|'#'
nl|'\n'
comment|'# If we were to let SloIterable handle all the range calculations, we'
nl|'\n'
comment|'# would be unable to make this optimization.'
nl|'\n'
dedent|''
dedent|''
name|'total_length'
...
newline|'\n'
nl|'\n'
comment|'# Just because a response shows that an object is a SLO manifest does'
nl|'\n'
comment|"# not mean that response's body contains the entire SLO manifest. If"
nl|'\n'
comment|"# it doesn't, we need to make a second request to actually get the"
nl|'\n'
comment|'# whole thing.'
nl|'\n'
dedent|''
...
nl|'\n'
comment|'# start byte, end byte), but SloIterable wants (obj path, etag, size,'
nl|'\n'
comment|'# start byte, end byte), so we clean that up here'
nl|'\n'
