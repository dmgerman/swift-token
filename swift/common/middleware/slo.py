...
nl|'\n'
nl|'\n'
DECL|variable|DEFAULT_RATE_LIMIT_UNDER_SIZE
name|'DEFAULT_RATE_LIMIT_UNDER_SIZE'
op|'='
number|'1024'
op|'*'
number|'1024'
...
name|'append'
op|'('
string|'"Index %d: too small; each segment must be "'
nl|'\n'
...
name|'agent'
op|'='
string|"'%(orig)s SLO MultipartGET'"
op|','
name|'swift_source'
op|'='
string|"'SLO'"
...
newline|'\n'
nl|'\n'
DECL|member|convert_segment_listing
dedent|''
name|'def'
name|'convert_segment_listing'
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|_get_manifest_read
dedent|''
name|'def'
name|'_get_manifest_read'
op|'('
...
newline|'\n'
nl|'\n'
DECL|function|is_small_segment
name|'def'
name|'is_small_segment'
op|'('
op|'('
name|'seg_dict'
op|','
...
name|'agent'
op|'='
string|"'%(orig)s SLO MultipartPUT'"
op|','
name|'swift_source'
op|'='
string|"'SLO'"
...
op|','
nl|'\n'
string|"'Too small; each segment must be at least 1 byte.'"
op|']'
op|')'
newline|'\n'
dedent|''
...
op|'='
name|'None'
comment|'# Ignore content-type from client'
newline|'\n'
name|'resp'
op|'='
name|'HTTPOk'
...
op|','
nl|'\n'
comment|'# this used to be configurable; report it as 1 for'
nl|'\n'
comment|'# clients that might still care'
nl|'\n'
