...
number|'404'
op|','
comment|'# get for the previous version'
nl|'\n'
number|'200'
op|','
number|'200'
...
number|'200'
op|','
comment|'# get for the pre-previous'
nl|'\n'
number|'201'
op|','
number|'201'
...
number|'201'
op|','
comment|'# put move the pre-previous'
nl|'\n'
number|'204'
op|','
number|'204'
...
number|'204'
op|','
comment|'# delete for the pre-previous'
nl|'\n'
name|'give_connect'
op|'='
name|'test_connect'
...
name|'fake_container_info'
newline|'\n'
comment|'# patching _listing_iter simulates request being authorized'
nl|'\n'
comment|'# to list versions container'
nl|'\n'
name|'controller'
op|'.'
name|'_listing_iter'
...
newline|'\n'
nl|'\n'
comment|"# make sure dlo manifest files don't get versioned"
nl|'\n'
name|'for'
name|'_junk'
name|'in'
...
newline|'\n'
nl|'\n'
comment|'# Servers obj1 and obj2 will have the first version of the object'
nl|'\n'
name|'prosrv'
op|'.'
name|'_error_limiting'
...
newline|'\n'
nl|'\n'
comment|'# Server obj3 (and, in real life, some handoffs) will have the'
nl|'\n'
comment|'# second version of the object.'
nl|'\n'
name|'prosrv'
op|'.'
name|'_error_limiting'
...
op|'('
nl|'\n'
string|"'swift.proxy.controllers.base.Controller._quorum_size'"
op|','
nl|'\n'
name|'lambda'
op|'*'
