...
op|')'
newline|'\n'
DECL|variable|constraints_conf_exists
...
op|')'
newline|'\n'
comment|'#: Max size of any header'
nl|'\n'
...
op|')'
newline|'\n'
comment|'# A simple dictionary of all the constraints that can be specified in the'
nl|'\n'
comment|'# SWIFT_CONF_FILE.'
nl|'\n'
