...
name|'_'
op|'('
string|"'Loading JSON from %s failed (%s)'"
op|')'
op|'%'
op|'('
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# non-tombstones older than or equal to latest tombstone are obsolete'
nl|'\n'
name|'if'
name|'exts'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# all but most recent .meta and .ts are obsolete'
nl|'\n'
dedent|''
dedent|''
name|'for'
...
op|':'
newline|'\n'
comment|'# only report a meta file if there is a data file'
nl|'\n'
indent|'            '
name|'results'
op|'['
...
newline|'\n'
nl|'\n'
comment|'# set ts_file, data_file and meta_file with path to chosen file or None'
nl|'\n'
dedent|''
name|'for'
name|'info_key'
...
name|'_'
op|'('
string|"'No space left on device for %s (%s)'"
op|')'
op|'%'
nl|'\n'
op|'('
...
name|'_'
op|'('
string|"'Problem cleaning up %s (%s)'"
op|')'
op|'%'
nl|'\n'
op|'('
...
name|'_'
op|'('
string|"'Problem writing durable state file %s (%s)'"
op|')'
op|'%'
nl|'\n'
op|'('
...
newline|'\n'
nl|'\n'
comment|'# Fragments *may* be ready for reclaim, unless they are durable or'
nl|'\n'
comment|'# at the timestamp we have just chosen for constructing the diskfile.'
nl|'\n'
dedent|''
name|'for'
name|'frag_set'
