...
op|'('
nl|'\n'
string|'\'Manifest object name "%s" \''
nl|'\n'
string|"'cannot be included in the manifest'"
nl|'\n'
op|'%'
name|'obj_name'
op|')'
...
op|':'
newline|'\n'
comment|'# Since we now know the length, we can normalize the ranges'
nl|'\n'
indent|'                    '
name|'ranges'
op|'='
