...
name|'value'
newline|'\n'
comment|'# TODO: Make this a separate column, not a metadata item.'
nl|'\n'
comment|'# Each db should track what it has synced separately and'
nl|'\n'
comment|'# these metadata get ovewritten by newer values from other'
nl|'\n'
comment|"# dbs. Also, once a new column, it'll need special"
nl|'\n'
comment|'# attention when doing a fresh db copy.'
nl|'\n'
dedent|''
name|'elif'
name|'key'
