...
name|'error'
op|'('
string|"'%s/%s responded as unmounted'"
op|'%'
nl|'\n'
op|'('
name|'node'
...
name|'info'
op|'('
string|'"%d/%d (%.2f%%) partitions replicated in %.2f "'
nl|'\n'
string|'"seconds (%.2f/sec, %s remaining)"'
nl|'\n'
op|'%'
op|'('
name|'self'
...
name|'info'
op|'('
string|'"%d suffixes checked - %.2f%% hashed, "'
nl|'\n'
string|'"%.2f%% synced"'
op|'%'
nl|'\n'
...
name|'info'
op|'('
string|'"Partition times: max %.4fs, min %.4fs, "'
nl|'\n'
string|'"med %.4fs"'
nl|'\n'
op|'%'
