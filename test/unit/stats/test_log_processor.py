...
string|"'/v1/AUTH_acct/foo/bar?format=json&foo HTTP/1.0 200 - '"
...
newline|'\n'
nl|'\n'
DECL|member|test_log_line_parser
name|'def'
name|'test_log_line_parser'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_process_one_stats_file
dedent|''
name|'def'
name|'test_process_one_stats_file'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_data_listing
dedent|''
name|'def'
name|'test_get_data_listing'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_get_aggr_access_logs
dedent|''
name|'def'
name|'test_get_aggr_access_logs'
op|'('
name|'self'
op|')'
op|':'
...
op|'{'
op|'('
string|"'AUTH_7abbc116-8a07-4b63-819d-02715d3e0f31'"
op|','
string|"'2010'"
op|','
string|"'07'"
