...
op|']'
newline|'\n'
comment|'# Find a tier with the minimal replica count and the'
nl|'\n'
comment|'# hungriest drive among all the tiers with the minimal'
nl|'\n'
...
name|'None'
op|')'
comment|'# May be absent for devices w/o weight'
newline|'\n'
nl|'\n'
