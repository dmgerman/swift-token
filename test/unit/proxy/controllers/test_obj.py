...
op|','
nl|'\n'
string|'"invalid backend-content-length for conn %r"'
op|'%'
op|'('
nl|'\n'
name|'connection_id'
...
newline|'\n'
nl|'\n'
comment|'# assert length was correct for this connection'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
op|')'
newline|'\n'
comment|'# assert length was the same for all connections'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
