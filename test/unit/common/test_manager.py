...
nl|'\n'
nl|'\n'
DECL|class|TestMangerModule
dedent|''
name|'class'
name|'TestMangerModule'
op|'('
name|'unittest'
op|'.'
name|'TestCase'
...
name|'server'
newline|'\n'
DECL|function|get_running_pids
name|'def'
name|'get_running_pids'
op|'('
op|')'
...
op|')'
newline|'\n'
comment|'# self.assertEquals([x for x in gen], [])'
nl|'\n'
dedent|''
name|'finally'
op|':'
...
op|')'
newline|'\n'
comment|'# test no error code on error'
nl|'\n'
DECL|variable|init
name|'init'
op|'='
