...
name|'body'
op|'='
string|'"profile=all&sort=time&limit=-1&fulldirs=1&nfl_filter=__call__"'
op|'+'
string|'"&query=query&metric=nc&format=default"'
newline|'\n'
name|'wsgi_input'
op|'='
name|'StringIO'
...
name|'body'
op|'='
string|'"sort=time&limit=-1&fulldirs=1&nfl_filter="'
op|'+'
string|'"&metric=nc"'
newline|'\n'
name|'wsgi_input'
...
name|'body'
op|'+'
string|"'&profile=ABC&download=download'"
op|')'
newline|'\n'
name|'environ'
op|'['
...
name|'body'
op|'+'
string|"'&download=download&format=ods'"
op|')'
newline|'\n'
name|'environ'
op|'['
...
name|'body'
op|'='
string|'"profile=123&profile=456&sort=time&sort=nc&limit=10"'
op|'+'
string|'"&fulldirs=1&nfl_filter=getcwd&query=query&metric=nc"'
newline|'\n'
name|'wsgi_input'
op|'='
name|'StringIO'
