...
newline|'\n'
nl|'\n'
DECL|member|test_PUT_then_POST_async_updates_with_repl_policy
dedent|''
name|'def'
name|'test_PUT_then_POST_async_updates_with_repl_policy'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_PUT_then_POST_async_updates_with_EC_policy
dedent|''
name|'def'
name|'test_PUT_then_POST_async_updates_with_EC_policy'
op|'('
name|'self'
op|')'
op|':'
