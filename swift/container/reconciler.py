...
op|':'
newline|'\n'
comment|"# I'm guessing to avoid rounding errors Swift uses a 10-microsecond"
nl|'\n'
comment|"# resolution instead of Python's 1-microsecond resolution."
nl|'\n'
indent|'    '
name|'offset'
op|'*='
...
string|"'lost_source'"
op|','
string|"'%r (%f) was not available in '"
nl|'\n'
...
string|"'%r (%f) in '"
nl|'\n'
string|"'policy_index %s responded %s (%f)'"
op|','
name|'path'
op|','
nl|'\n'
...
nl|'\n'
string|"'reconcile %r (%s) in policy_index %s'"
op|','
nl|'\n'
name|'info'
op|'['
