...
name|'info'
op|'('
string|'\'Processing %s/%s/%s with plugin "%s"\''
op|'%'
op|'('
name|'account'
op|','
...
nl|'\n'
comment|'# to then end_key to make sure we get all the data under the'
nl|'\n'
comment|"# last hour. Adding '/\\x7f' should be all inclusive."
nl|'\n'
name|'end_key'
op|'='
string|"'/'"
...
name|'debug'
op|'('
string|"'Bad compressed data for %s/%s/%s'"
op|'%'
nl|'\n'
op|'('
name|'swift_account'
