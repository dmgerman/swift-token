...
newline|'\n'
nl|'\n'
DECL|member|test_deprecated_glob_style_upload_all_logs
dedent|''
name|'def'
name|'test_deprecated_glob_style_upload_all_logs'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
comment|'# deprecated warning on source_filename_format'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# convert source_filename_format to regex'
nl|'\n'
dedent|''
name|'conf'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# use source_filename_pattern if we have the choice!'
nl|'\n'
name|'conf'
op|'='
op|'{'
...
name|'pattern'
op|'='
string|"r'prefix_.*_[0-9]+\\.blah\\.%Y%m%d%H00-[0-9]{2}00'"
string|"'-[0-9]?[0-9]\\.gz'"
newline|'\n'
