...
op|':'
newline|'\n'
comment|'# force all timestamps to fall in same hour'
nl|'\n'
indent|'        '
name|'ts'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# add another misplaced row to *local* broker with composite timestamp'
nl|'\n'
name|'ts_data'
op|'='
name|'next'
...
newline|'\n'
nl|'\n'
comment|'# and we should have also enqueued these rows in a single reconciler,'
nl|'\n'
comment|'# since we forced the object timestamps to be in the same hour.'
nl|'\n'
dedent|''
name|'reconciler'
op|'='
...
op|')'
newline|'\n'
comment|"# the second object's listing has ts_meta as its last modified time"
nl|'\n'
comment|'# but its full composite timestamp is in the hash field.'
nl|'\n'
name|'expected'
op|'='
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|test_update_sync_store_exception
dedent|''
name|'def'
name|'test_update_sync_store_exception'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
DECL|class|FakeContainerSyncStore
indent|'        '
name|'class'
name|'FakeContainerSyncStore'
op|'('
name|'object'
op|')'
op|':'
...
name|'assertIn'
op|'('
string|"'Failed to update sync_store'"
op|','
name|'log_lines'
op|'['
number|'0'
...
newline|'\n'
nl|'\n'
DECL|member|test_update_sync_store
dedent|''
name|'def'
name|'test_update_sync_store'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# sync-to and sync-key empty - remove from store'
nl|'\n'
name|'broker'
op|'.'
name|'update_metadata'
...
op|')'
newline|'\n'
comment|'# sync-to is not empty sync-key is empty - remove from store'
nl|'\n'
name|'broker'
op|'.'
name|'update_metadata'
...
op|')'
newline|'\n'
comment|'# sync-to is empty sync-key is not empty - remove from store'
nl|'\n'
name|'broker'
op|'.'
name|'update_metadata'
...
op|')'
newline|'\n'
comment|'# sync-to, sync-key both not empty - add to store'
nl|'\n'
name|'broker'
op|'.'
name|'update_metadata'
...
op|')'
newline|'\n'
comment|'# container is removed - need to remove from store'
nl|'\n'
name|'broker'
op|'.'
name|'delete_db'
...
newline|'\n'
nl|'\n'
DECL|member|test_sync_triggers_sync_store_update
dedent|''
name|'def'
name|'test_sync_triggers_sync_store_update'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# Create two containers as follows:'
nl|'\n'
comment|'# broker_1 which is not set for sync'
nl|'\n'
comment|'# broker_2 which is set for sync and then unset'
nl|'\n'
comment|'# test that while replicating both we see no activity'
nl|'\n'
comment|'# for broker_1, and the anticipated activity for broker_2'
nl|'\n'
name|'broker_1'
op|'='
name|'self'
...
newline|'\n'
nl|'\n'
comment|'# replicate once according to broker_1'
nl|'\n'
comment|'# relying on the fact that FakeRing would place both'
nl|'\n'
comment|'# in the same partition.'
nl|'\n'
name|'part'
op|','
name|'node'
...
op|')'
newline|'\n'
comment|'# replicate once this time according to broker_2'
nl|'\n'
comment|'# relying on the fact that FakeRing would place both'
nl|'\n'
comment|'# in the same partition.'
