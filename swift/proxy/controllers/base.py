...
op|'('
nl|'\n'
string|"'x-container-meta-access-control-allow-headers'"
op|')'
op|','
nl|'\n'
...
op|')'
newline|'\n'
comment|'# Use a unique environment cache key per container.  If you copy this env'
nl|'\n'
comment|"# to make a new request, it won't accidentally reuse the old container info"
nl|'\n'
name|'env_key'
op|'='
string|"'swift.%s'"
...
op|')'
newline|'\n'
comment|'# Use a unique environment cache key per account.  If you copy this env'
nl|'\n'
comment|"# to make a new request, it won't accidentally reuse the old account info"
nl|'\n'
name|'env_key'
op|'='
string|"'swift.%s'"
...
name|'_'
op|'('
string|"'ERROR %(status)d %(body)s From Account '"
nl|'\n'
string|"'Server'"
op|')'
op|'%'
...
op|'('
nl|'\n'
string|"'ERROR %(status)d %(body)s From Container '"
nl|'\n'
string|"'Server'"
op|')'
op|'%'
...
newline|'\n'
nl|'\n'
comment|'# Always allow the x-auth-token header. This ensures'
nl|'\n'
comment|'# clients can always make a request to the resource.'
nl|'\n'
dedent|''
name|'allow_headers'
op|'='
