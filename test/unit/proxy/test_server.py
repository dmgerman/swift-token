...
name|'patch'
op|'('
string|"'swift.proxy.controllers.base.ChunkWriteTimeout'"
op|','
nl|'\n'
name|'WrappedTimeout'
op|')'
...
op|')'
newline|'\n'
comment|'# check that no coro was left waiting to write'
nl|'\n'
name|'self'
op|'.'
name|'assertTrue'
...
name|'timeouts'
op|')'
comment|'# sanity - WrappedTimeout did get called'
newline|'\n'
name|'missing_exits'
op|'='
name|'filter'
...
name|'missing_exits'
op|','
string|"'Failed to exit all ChunkWriteTimeouts.\\n'"
op|'+'
nl|'\n'
string|"''"
op|'.'
...
op|'('
op|'['
string|"'No exit from ChunkWriteTimeout entered at:\\n'"
op|'+'
nl|'\n'
string|"''"
op|'.'
...
op|')'
newline|'\n'
comment|'# and check that the ChunkWriteTimeouts did not raise Exceptions'
nl|'\n'
name|'self'
op|'.'
name|'assertFalse'
...
newline|'\n'
nl|'\n'
DECL|member|_get_CORS_response
dedent|''
dedent|''
name|'def'
name|'_get_CORS_response'
op|'('
name|'self'
op|','
name|'container_cors'
...
newline|'\n'
nl|'\n'
DECL|member|test_CORS_valid_non_strict
dedent|''
dedent|''
name|'def'
name|'test_CORS_valid_non_strict'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# test expose_headers to non-allowed origins'
nl|'\n'
indent|'        '
name|'container_cors'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# test allow_origin empty'
nl|'\n'
name|'container_cors'
op|'='
op|'{'
...
newline|'\n'
nl|'\n'
DECL|member|test_CORS_valid_strict
dedent|''
name|'def'
name|'test_CORS_valid_strict'
op|'('
name|'self'
op|')'
op|':'
