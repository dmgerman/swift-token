...
newline|'\n'
nl|'\n'
DECL|function|mock_kill_group
dedent|''
dedent|''
dedent|''
name|'def'
name|'mock_kill_group'
op|'('
name|'pid'
op|','
name|'sig'
...
name|'fail'
op|'('
string|"'kill_group should not be called'"
op|')'
newline|'\n'
nl|'\n'
dedent|''
...
newline|'\n'
nl|'\n'
DECL|member|test_stop_kill_after_timeout
dedent|''
dedent|''
name|'def'
name|'test_stop_kill_after_timeout'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|mock_kill_group_oserr
dedent|''
name|'def'
name|'mock_kill_group_oserr'
op|'('
op|'*'
name|'args'
op|')'
...
newline|'\n'
nl|'\n'
DECL|function|mock_kill_group_oserr_ESRCH
dedent|''
name|'def'
name|'mock_kill_group_oserr_ESRCH'
op|'('
op|'*'
name|'args'
op|')'
...
name|'mock_kill_group_oserr'
newline|'\n'
comment|'# test stop one server - OSError'
nl|'\n'
name|'server_pids'
op|'='
op|'{'
...
name|'mock_kill_group_oserr_ESRCH'
newline|'\n'
comment|'# test stop one server - OSError: No such process'
nl|'\n'
name|'server_pids'
op|'='
op|'{'
