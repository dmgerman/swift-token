...
op|':'
newline|'\n'
comment|'# Verify that a request with read access to a versions container'
nl|'\n'
comment|'# is unable to cause any write operations on the versioned container.'
nl|'\n'
nl|'\n'
comment|'# reset the router post patch_policies'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# Firts byte is aligned to a segment boundary, last byte is not'
nl|'\n'
indent|'        '
name|'status'
op|','
