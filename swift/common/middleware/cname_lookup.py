...
op|':'
newline|'\n'
comment|'# catch this to allow docs to be built without the dependency'
nl|'\n'
DECL|variable|MODULE_DEPENDENCY_MET
indent|'    '
name|'MODULE_DEPENDENCY_MET'
op|'='
name|'False'
newline|'\n'
dedent|''
name|'else'
op|':'
comment|'# executed if the try block finishes with no errors'
newline|'\n'
DECL|variable|MODULE_DEPENDENCY_MET
indent|'    '
name|'MODULE_DEPENDENCY_MET'
...
op|':'
newline|'\n'
comment|"# reraise the exception if the dependency wasn't met"
nl|'\n'
indent|'            '
name|'raise'
name|'ImportError'
op|'('
string|"'dnspython is required for this module'"
op|')'
newline|'\n'
dedent|''
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|_domain_endswith_in_storage_domain
dedent|''
name|'def'
name|'_domain_endswith_in_storage_domain'
op|'('
name|'self'
op|','
name|'a_domain'
