...
comment|'#'
nl|'\n'
comment|'# "after" (optional) is a list of middlewares that this middleware should come'
nl|'\n'
comment|'# after. Default is for the middleware to go at the start of the pipeline. Any'
nl|'\n'
comment|'# middlewares in the "after" list that are not present in the pipeline will be'
nl|'\n'
comment|'# ignored, so you can safely name optional middlewares to come after. For'
nl|'\n'
comment|'# example, \'after: ["catch_errors", "bulk"]\' would install this middleware'
nl|'\n'
comment|'# after catch_errors and bulk if both were present, but if bulk were absent,'
nl|'\n'
comment|'# would just install it after catch_errors.'
nl|'\n'
comment|'#'
nl|'\n'
comment|'# "after_fn" (optional) a function that takes a PipelineWrapper object as its'
nl|'\n'
comment|'# single argument and returns a list of middlewares that this middleware should'
nl|'\n'
comment|'# come after. This list overrides any defined by the "after" field.'
nl|'\n'
...
op|')'
newline|'\n'
comment|'# Remove any x-backend-* headers since those are reserved for use'
nl|'\n'
comment|'# by backends communicating with each other; no end user should be'
nl|'\n'
comment|'# able to send those into the cluster.'
nl|'\n'
dedent|''
name|'for'
name|'key'
