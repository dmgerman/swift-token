...
op|']'
newline|'\n'
comment|'# cand_objs is a list of objects for deletion'
nl|'\n'
dedent|''
name|'success'
op|','
...
newline|'\n'
nl|'\n'
DECL|member|delete_handoff_paths
dedent|''
dedent|''
name|'def'
name|'delete_handoff_paths'
...
name|'continue'
newline|'\n'
comment|'# may need to branch here for future policy types'
nl|'\n'
dedent|''
name|'jobs'
op|'+='
