...
op|'}'
newline|'\n'
comment|'# account_info returns after 3 non 2xx responses unless autocreate'
nl|'\n'
comment|'# is True'
nl|'\n'
name|'set_http_connect'
...
op|')'
newline|'\n'
comment|'# Test a case when less than quorum responded 2xx during'
nl|'\n'
comment|'# account create'
nl|'\n'
name|'self'
op|'.'
name|'assert_status_map'
