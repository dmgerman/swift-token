...
op|':'
newline|'\n'
comment|"# swift.conf exists, so use what's defined there (or swift"
nl|'\n'
comment|'# defaults) This normally happens when the test is running locally'
nl|'\n'
comment|'# to the cluster as in a SAIO.'
nl|'\n'
indent|'            '
name|'config'
op|'['
...
op|':'
newline|'\n'
comment|"# .functests don't know what the constraints of the tested cluster"
nl|'\n'
comment|"# are, so the tests can't reliably pass or fail. Therefore, skip"
nl|'\n'
comment|'# those tests.'
nl|'\n'
indent|'            '
