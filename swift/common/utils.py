...
string|"'NOTICE'"
newline|'\n'
comment|'# syslog priority "notice" is used for proxy access log lines'
nl|'\n'
name|'SysLogHandler'
op|'.'
name|'priority_map'
...
nl|'\n'
nl|'\n'
comment|'# double inhereitence to support property with setter'
nl|'\n'
...
name|'False'
newline|'\n'
comment|'# all swift new handlers will get the same formatter'
nl|'\n'
name|'formatter'
op|'='
name|'TxnFormatter'
...
newline|'\n'
nl|'\n'
comment|'# a single swift logger will only get one SysLog Handler'
nl|'\n'
name|'if'
name|'not'
name|'hasattr'
