...
nl|'\n'
comment|'# so lets do a set with indicies from different nodes'
nl|'\n'
indent|'                '
name|'if'
name|'set'
...
op|':'
newline|'\n'
comment|"# won't include this in the final, just handy reminder of where"
nl|'\n'
comment|'# things are...'
nl|'\n'
indent|'        '
...
name|'patch'
op|'('
string|"'swift.obj.reconstructor.ismount'"
op|','
nl|'\n'
name|'fake_ismount'
op|')'
