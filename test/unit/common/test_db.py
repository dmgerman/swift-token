...
newline|'\n'
nl|'\n'
DECL|member|test_metadata_raises_exception_on_non_utf8
dedent|''
dedent|''
name|'def'
name|'test_metadata_raises_exception_on_non_utf8'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
DECL|function|try_validate
indent|'        '
name|'def'
name|'try_validate'
op|'('
...
name|'fail'
op|'('
string|"'HTTPException not raised'"
op|')'
newline|'\n'
dedent|''
dedent|''
