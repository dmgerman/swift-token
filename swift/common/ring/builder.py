...
op|':'
newline|'\n'
comment|'# There exists at least one tier with 0 other'
nl|'\n'
comment|'# replicas, so avoid calling the min() below, which is'
nl|'\n'
comment|"# expensive if you've got thousands of drives."
nl|'\n'
indent|'                        '
...
op|')'
newline|'\n'
comment|'# Find the first tier with the minimal replica count.'
nl|'\n'
comment|"# Since they're sorted, this will also have the hungriest"
nl|'\n'
comment|'# drive among all the tiers with the minimal replica'
nl|'\n'
comment|'# count.'
nl|'\n'
dedent|''
