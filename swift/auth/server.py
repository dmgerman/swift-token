...
name|'execute'
op|'('
string|'"ALTER TABLE account ADD COLUMN admin TEXT"'
op|')'
newline|'\n'
name|'self'
op|'.'
...
name|'execute'
op|'('
string|'"UPDATE account SET admin = \'t\'"'
op|')'
newline|'\n'
dedent|''
dedent|''
...
name|'execute'
op|'('
string|"'SELECT reseller_admin FROM account LIMIT 1'"
op|')'
newline|'\n'
dedent|''
name|'except'
...
op|')'
op|'=='
string|"'no such column: reseller_admin'"
op|':'
newline|'\n'
indent|'                '
name|'self'
...
op|'('
nl|'\n'
string|'"ALTER TABLE account ADD COLUMN reseller_admin TEXT"'
op|')'
newline|'\n'
dedent|''
dedent|''
...
op|')'
newline|'\n'
comment|'# Create a single use token.'
nl|'\n'
name|'token'
op|'='
string|"'%stk%s'"
...
name|'_'
op|'('
string|"'ERROR attempting to create account %(url)s:'"
string|"' %(status)s %(reason)s'"
op|')'
op|'%'
nl|'\n'
op|'{'
...
newline|'\n'
nl|'\n'
DECL|member|validate_s3_sign
dedent|''
dedent|''
name|'def'
name|'validate_s3_sign'
op|'('
name|'self'
op|','
name|'request'
...
op|')'
newline|'\n'
comment|'# Remove the token if it was expired or single use.'
nl|'\n'
dedent|''
name|'if'
name|'not'
...
name|'_'
op|'('
string|"'ALREADY EXISTS create_user(%(account)s, '"
nl|'\n'
string|"'%(user)s, _, %(admin)s, %(reseller_admin)s) '"
nl|'\n'
string|"'[%(elapsed).02f]'"
op|')'
op|'%'
...
name|'_'
op|'('
string|"'FAILED create_user(%(account)s, '"
nl|'\n'
string|"'%(user)s, _, %(admin)s, %(reseller_admin)s) '"
nl|'\n'
string|"'[%(elapsed).02f]'"
...
name|'_'
op|'('
string|"'SUCCESS create_user(%(account)s, %(user)s, _, '"
nl|'\n'
string|"'%(admin)s, %(reseller_admin)s) = %(url)s [%(elapsed).02f]'"
op|')'
op|'%'
nl|'\n'
op|'{'
...
op|':'
newline|'\n'
comment|'# admin access to a cfaccount or ".reseller_admin" to access to all'
nl|'\n'
comment|'# accounts, including creating new ones.'
nl|'\n'
indent|'            '
name|'groups'
op|'.'
