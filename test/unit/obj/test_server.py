...
newline|'\n'
nl|'\n'
comment|'# give the object server a few trampolines to recognize request'
nl|'\n'
comment|'# has finished, or socket has closed or whatever'
nl|'\n'
dedent|''
name|'sleep'
op|'('
...
op|')'
newline|'\n'
comment|'# And no continer update'
nl|'\n'
name|'self'
op|'.'
name|'assertFalse'
...
op|')'
newline|'\n'
comment|'# And continer update was called'
nl|'\n'
name|'self'
op|'.'
name|'assertTrue'
...
newline|'\n'
nl|'\n'
comment|"# but don't send final boundry or last chunk"
nl|'\n'
name|'to_send'
op|'='
string|'"%x\\r\\n%s\\r\\n"'
...
op|')'
newline|'\n'
comment|'# but no continer update'
nl|'\n'
name|'self'
op|'.'
name|'assertFalse'
