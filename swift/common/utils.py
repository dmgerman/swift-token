...
name|'try'
op|':'
comment|'# Not portable, and not available before linux 2.6.23.'
newline|'\n'
DECL|variable|sys_fallocate
indent|'    '
name|'sys_fallocate'
op|'='
name|'libc'
...
name|'try'
op|':'
comment|'# Not yet available on all OSs, or linux before 2.5.60.'
newline|'\n'
DECL|variable|posix_fadvise
indent|'    '
name|'posix_fadvise'
op|'='
name|'libc'
