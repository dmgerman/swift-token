...
newline|'\n'
nl|'\n'
comment|'# i guess fake_ring wants the get_more_nodes iter to more safely be'
nl|'\n'
comment|'# converted to a list with a smallish sort of limit which *can* be'
nl|'\n'
comment|'# lower than max_more_nodes'
nl|'\n'
name|'fake_rings_real_max_more_nodes_value'
op|'='
name|'object_ring'
op|'.'
name|'replicas'
