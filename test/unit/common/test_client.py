...
newline|'\n'
nl|'\n'
DECL|member|test_json_request
dedent|''
name|'def'
name|'test_json_request'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_auth_v2_no_tenant_name
dedent|''
name|'def'
name|'test_auth_v2_no_tenant_name'
op|'('
name|'self'
op|')'
op|':'
