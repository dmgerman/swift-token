...
comment|'# newer meta timestamp -> hex data delta encoded as extra message part'
nl|'\n'
comment|'# content type timestamp equals data timestamp -> no delta'
nl|'\n'
name|'expected'
op|'='
string|"'%s %s m:%x'"
...
newline|'\n'
nl|'\n'
comment|'# content type timestamp newer data timestamp -> delta encoded'
nl|'\n'
name|'expected'
op|'='
op|'('
...
newline|'\n'
nl|'\n'
comment|'# content type timestamp equal to meta timestamp -> delta encoded'
nl|'\n'
name|'expected'
op|'='
op|'('
