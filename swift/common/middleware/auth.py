...
op|':'
newline|'\n'
comment|'# N.B. no reseller_prefix will match all tokens!'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# because I own this token, I can deny it outright'
nl|'\n'
indent|'                    '
name|'return'
name|'HTTPUnauthorized'
...
op|':'
newline|'\n'
comment|"# default auth won't over-write swift.authorize"
nl|'\n'
indent|'                    '
name|'env'
op|'['
...
op|':'
newline|'\n'
comment|'# As a reseller, I would like to be calledback for annoynomous'
nl|'\n'
comment|'# access to my accounts'
nl|'\n'
indent|'                '
name|'version'
op|','
...
op|':'
newline|'\n'
comment|"# handle annoynomous access to my reseller's accounts"
nl|'\n'
indent|'                    '
name|'env'
op|'['
...
op|':'
newline|'\n'
comment|"# not my token, not my account, I can't authorize this"
nl|'\n'
comment|'# request, deny all is a good idea if not already set...'
nl|'\n'
indent|'                    '
name|'env'
op|'['
...
op|':'
newline|'\n'
comment|"# As a default auth, I'm willing to handle annoynomous requests"
nl|'\n'
comment|"# for all accounts, but I won't over-write swift.authorize"
nl|'\n'
indent|'                '
name|'env'
op|'['
