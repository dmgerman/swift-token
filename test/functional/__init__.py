...
nl|'\n'
nl|'\n'
DECL|function|fake_memcache_filter_factory
dedent|''
dedent|''
name|'def'
name|'fake_memcache_filter_factory'
op|'('
name|'conf'
op|')'
op|':'
newline|'\n'
DECL|function|filter_app
indent|'    '
name|'def'
name|'filter_app'
op|'('
...
op|':'
nl|'\n'
string|"'content-disposition, content-encoding, x-delete-at,'"
nl|'\n'
string|"' x-object-manifest, x-static-large-object'"
op|','
nl|'\n'
...
op|','
nl|'\n'
comment|'# For tempauth middleware'
nl|'\n'
...
op|','
nl|'\n'
string|"'user_test2_tester2'"
op|':'
string|"'testing2 .admin'"
op|','
nl|'\n'
