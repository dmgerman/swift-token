...
op|':'
newline|'\n'
comment|'# make a GET request to check object versions'
nl|'\n'
indent|'        '
name|'_headers'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|_put_versioned_obj
dedent|''
name|'def'
name|'_put_versioned_obj'
op|'('
name|'self'
op|','
name|'req'
...
op|':'
newline|'\n'
comment|'# Create a new Request object to PUT to the versions container, copying'
nl|'\n'
comment|'# all headers from the source object apart from x-timestamp.'
nl|'\n'
indent|'        '
name|'put_req'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|_check_response_error
dedent|''
name|'def'
name|'_check_response_error'
op|'('
name|'self'
op|','
name|'req'
...
op|')'
newline|'\n'
comment|'# could not version the data, bail'
nl|'\n'
dedent|''
name|'raise'
name|'HTTPServiceUnavailable'
...
op|':'
newline|'\n'
comment|'# do not version DLO manifest, proceed with original request'
nl|'\n'
indent|'            '
name|'return'
name|'self'
...
op|':'
newline|'\n'
comment|'# nothing to version, proceed with original request'
nl|'\n'
indent|'            '
name|'close_if_possible'
op|'('
...
newline|'\n'
nl|'\n'
comment|'# check for any other errors'
nl|'\n'
dedent|''
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# validate the write access to the versioned container before'
nl|'\n'
comment|'# making any backend requests'
nl|'\n'
indent|'                '
name|'if'
...
newline|'\n'
nl|'\n'
comment|'# redirect the original DELETE to the source of the reinstated'
nl|'\n'
comment|"# version object - we already auth'd original req so make a"
nl|'\n'
comment|'# pre-authed request'
nl|'\n'
name|'req'
op|'='
name|'make_pre_authed_request'
...
nl|'\n'
comment|'# adding location takes precedence over removing'
nl|'\n'
name|'if'
