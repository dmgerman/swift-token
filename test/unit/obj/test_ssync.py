...
op|')'
newline|'\n'
comment|'# o3 only has handoff, rx has other frag index'
nl|'\n'
name|'t3'
op|'='
name|'next'
...
newline|'\n'
nl|'\n'
DECL|member|test_handoff_fragment_only_missing_durable
dedent|''
name|'def'
name|'test_handoff_fragment_only_missing_durable'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# test that a sync_revert type job does not PUT when the rx is only'
nl|'\n'
comment|'# missing a durable file'
nl|'\n'
indent|'        '
name|'policy'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# o1 in sync on rx but rx missing .durable - no PUT required'
nl|'\n'
name|'t1a'
op|'='
name|'next'
...
name|'ts_iter'
op|')'
comment|'# older rx .data with .durable'
newline|'\n'
name|'t1b'
op|'='
name|'next'
...
name|'ts_iter'
op|')'
comment|'# tx .data with .durable, rx missing .durable'
newline|'\n'
name|'obj_name'
op|'='
string|"'o1'"
...
newline|'\n'
nl|'\n'
comment|'# o2 on rx has wrong frag_indexes and missing .durable - PUT required'
nl|'\n'
name|'t2'
op|'='
name|'next'
...
newline|'\n'
nl|'\n'
comment|'# o3 on rx has frag at other time missing .durable - PUT required'
nl|'\n'
name|'t3'
op|'='
name|'next'
...
newline|'\n'
nl|'\n'
comment|'# o4 on rx has a newer tombstone and even newer frags - no PUT required'
nl|'\n'
name|'t4'
op|'='
name|'next'
...
string|"'o4'"
op|')'
comment|"# o4 should not have been sync'd"
newline|'\n'
name|'self'
op|'.'
name|'_verify_ondisk_files'
