...
op|'='
number|'15'
comment|'# seconds to wait for servers to die'
newline|'\n'
nl|'\n'
...
indent|'        '
name|'print'
string|'"WARNING: Unable to increase file descriptor limit."'
...
newline|'\n'
indent|'        '
string|'"""spawn server and wait for it to start\n        """'
newline|'\n'
name|'kwargs'
op|'['
string|"'wait'"
...
newline|'\n'
indent|'        '
string|'"""start a server interactivly\n        """'
newline|'\n'
name|'kwargs'
op|'['
string|"'daemon'"
...
indent|'                '
name|'print'
string|"'Waited 15 seconds for %s to die; giving up'"
op|'%'
op|'('
name|'server'
op|')'
...
op|')'
newline|'\n'
comment|'# limt pid_files the one who translates to the indexed ini_file for'
nl|'\n'
comment|'# this given number'
nl|'\n'
name|'pid_files'
op|'='
op|'['
...
op|':'
newline|'\n'
comment|"#print '%s sig err: %s' % (pid, e)"
nl|'\n'
indent|'                '
name|'if'
name|'e'
...
newline|'\n'
nl|'\n'
comment|'# TODO: check if self.cmd exists?'
nl|'\n'
nl|'\n'
dedent|''
name|'pids'
