...
comment|'# NOTE(sileht):'
nl|'\n'
comment|'#     monkey-patching thread is required by python-keystoneclient;'
nl|'\n'
comment|'#     monkey-patching select is required by oslo.messaging pika driver'
nl|'\n'
comment|'#         if thread is monkey-patched.'
nl|'\n'
name|'eventlet'
op|'.'
name|'patcher'
