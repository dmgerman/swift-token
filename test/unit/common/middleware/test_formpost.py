...
newline|'\n'
nl|'\n'
comment|'# Fake out the caching layer so that get_account_info() finds its'
nl|'\n'
comment|"# data. Include something that isn't tempurl keys to prove we skip it."
nl|'\n'
name|'meta'
op|'='
op|'{'
string|"'user-job-title'"
op|':'
string|"'Personal Trainer'"
op|','
nl|'\n'
string|"'user-real-name'"
op|':'
string|"'Jim Shortz'"
op|'}'
newline|'\n'
...
name|'env'
op|'['
string|"'swift.account/AUTH_test'"
op|']'
op|'='
name|'self'
op|'.'
...
op|','
nl|'\n'
string|"'swift.container/AUTH_test/container'"
op|':'
op|'{'
string|"'meta'"
op|':'
...
nl|'\n'
comment|'# (and FakeApp verifies that no QUERY_STRING got passed).'
nl|'\n'
name|'self'
op|'.'
name|'assertEquals'
...
newline|'\n'
nl|'\n'
DECL|member|test_formpost_without_useragent
dedent|''
name|'def'
name|'test_formpost_without_useragent'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_formpost_with_origin
dedent|''
name|'def'
name|'test_formpost_with_origin'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_formpost_with_multiple_keys
dedent|''
name|'def'
name|'test_formpost_with_multiple_keys'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# Stick it in X-Account-Meta-Temp-URL-Key-2 and make sure we get it'
nl|'\n'
name|'env'
op|'['
string|"'swift.account/AUTH_test'"
...
newline|'\n'
nl|'\n'
DECL|member|test_formpost_with_multiple_container_keys
dedent|''
name|'def'
name|'test_formpost_with_multiple_container_keys'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# Stick it in X-Container-Meta-Temp-URL-Key-2 and ensure we get it'
nl|'\n'
name|'env'
op|'['
string|"'swift.container/AUTH_test/container'"
...
newline|'\n'
nl|'\n'
DECL|member|test_x_delete_at
dedent|''
name|'def'
name|'test_x_delete_at'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
string|'\'Content-Disposition: form-data; name="x_delete_at"\''
op|','
nl|'\n'
string|"''"
op|','
...
newline|'\n'
nl|'\n'
DECL|member|test_x_delete_at_not_int
dedent|''
name|'def'
name|'test_x_delete_at_not_int'
op|'('
name|'self'
op|')'
op|':'
...
name|'assertTrue'
op|'('
string|"'FormPost: x_delete_at not an integer'"
name|'in'
name|'body'
op|')'
newline|'\n'
nl|'\n'
DECL|member|test_x_delete_after
dedent|''
name|'def'
name|'test_x_delete_after'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
string|'\'Content-Disposition: form-data; name="x_delete_after"\''
op|','
nl|'\n'
string|"''"
op|','
...
newline|'\n'
nl|'\n'
DECL|member|test_x_delete_after_not_int
dedent|''
name|'def'
name|'test_x_delete_after_not_int'
op|'('
name|'self'
op|')'
op|':'
...
name|'assertTrue'
op|'('
string|"'FormPost: x_delete_after not an integer'"
name|'in'
name|'body'
op|')'
newline|'\n'
