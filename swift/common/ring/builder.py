...
op|':'
newline|'\n'
comment|'# There exists at least one tier with 0 other replicas,'
nl|'\n'
comment|'# so work backward among the candidates, accepting the'
nl|'\n'
comment|"# first which isn't in other_replicas."
nl|'\n'
comment|'#'
nl|'\n'
comment|'# This optimization is to avoid calling the min()'
nl|'\n'
comment|"# below, which is expensive if you've got thousands of"
nl|'\n'
comment|'# drives.'
nl|'\n'
indent|'                        '
