...
op|':'
newline|'\n'
comment|'# ctx.object is a reference to the actual filter_factory'
nl|'\n'
comment|"# function, so we pretty-print that. It's not the nice short"
nl|'\n'
comment|'# entry point, but it beats "<unknown>".'
nl|'\n'
comment|'#'
nl|'\n'
comment|'# These happen when, instead of something like'
nl|'\n'
comment|'#'
nl|'\n'
comment|'#    use = egg:swift#healthcheck'
nl|'\n'
comment|'#'
nl|'\n'
...
comment|'#'
nl|'\n'
comment|'#    paste.filter_factory = \\'
nl|'\n'
comment|'#        swift.common.middleware.healthcheck:filter_factory'
nl|'\n'
indent|'            '
name|'return'
string|'"%s:%s"'
...
newline|'\n'
indent|'    '
string|'"""Same as :py:func:`make_request` but with preauthorization."""'
newline|'\n'
name|'return'
name|'make_request'
op|'('
