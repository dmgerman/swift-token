...
op|'['
nl|'\n'
string|'"Can\'t find itself 127.0.0.1 with port 1000 "'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_run_once_with_local_device_in_ring
dedent|''
name|'def'
name|'test_run_once_with_local_device_in_ring'
op|'('
name|'self'
op|')'
op|':'
...
name|'base'
op|'='
string|"'swift.common.db_replicator.'"
newline|'\n'
name|'with'
name|'patch'
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|test_replicate_container_out_of_place_no_node
dedent|''
name|'def'
name|'test_replicate_container_out_of_place_no_node'
op|'('
name|'self'
op|')'
op|':'
