...
newline|'\n'
nl|'\n'
DECL|member|test_get_user_reseller_admin_succeed_getting_reseller_admin
dedent|''
name|'def'
name|'test_get_user_reseller_admin_succeed_getting_reseller_admin'
op|'('
name|'self'
op|')'
op|':'
...
op|','
nl|'\n'
comment|'# GET of user object (reseller admin check)'
nl|'\n'
op|'('
string|"'200 Ok'"
op|','
