...
op|')'
newline|'\n'
comment|'# Constraints are set first from the test config, then from'
nl|'\n'
comment|"# /etc/swift/swift.conf if it exists. If swift.conf doesn't exist,"
nl|'\n'
...
op|':'
newline|'\n'
comment|"# prefer what's in test.conf"
nl|'\n'
indent|'        '
name|'config'
op|'['
...
op|':'
newline|'\n'
comment|"# swift.conf exists, so use what's defined there (or swift defaults)"
nl|'\n'
comment|'# This normally happens when the test is running locally to the cluster'
nl|'\n'
comment|'# as in a SAIO.'
nl|'\n'
indent|'        '
name|'config'
op|'['
...
op|':'
newline|'\n'
comment|"# .functests don't know what the constraints of the tested cluster are,"
nl|'\n'
comment|"# so the tests can't reliably pass or fail. Therefore, skip those"
nl|'\n'
comment|'# tests.'
nl|'\n'
indent|'        '
...
op|']'
op|'='
string|"'%s constraint is not defined'"
op|'%'
name|'k'
newline|'\n'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# Copying the manifest should result in another manifest'
nl|'\n'
indent|'        '
name|'try'
op|':'
...
op|':'
newline|'\n'
comment|"# Can't tell if SLO is enabled or not since we're running"
nl|'\n'
comment|"# against an old cluster, so let's skip the tests instead of"
nl|'\n'
comment|'# possibly having spurious failures.'
nl|'\n'
indent|'                '
name|'cls'
op|'.'
...
op|':'
newline|'\n'
comment|"# Don't bother looking for ValueError here. If something is"
nl|'\n'
comment|'# responding to a GET /info request with invalid JSON, then'
nl|'\n'
comment|'# the cluster is broken and a test failure will let us know.'
nl|'\n'
indent|'                '
name|'cluster_info'
op|'='
