...
name|'Exception'
op|'('
string|"'Metadata incorrect, was %s'"
op|'%'
name|'repr'
op|'('
name|'oheaders'
...
name|'Exception'
op|'('
string|"'Handoff server claimed it had the object when '"
nl|'\n'
string|"'it should not have it'"
op|')'
newline|'\n'
dedent|''
name|'self'
...
name|'Exception'
op|'('
string|"'Previously downed object server had the new '"
nl|'\n'
string|"'metadata when it should not have it'"
op|')'
newline|'\n'
comment|"# Run the extra server last so it'll remove it's extra partition"
nl|'\n'
...
op|'('
nl|'\n'
string|"'Previously downed object server did not have the new metadata'"
op|')'
newline|'\n'
nl|'\n'
dedent|''
