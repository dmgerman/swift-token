...
newline|'\n'
nl|'\n'
DECL|member|test_too_small_x_timestamp
dedent|''
name|'def'
name|'test_too_small_x_timestamp'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# shunt_inbound_x_timestamp must be false'
nl|'\n'
indent|'            '
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_too_big_x_timestamp
dedent|''
dedent|''
name|'def'
name|'test_too_big_x_timestamp'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# To avoid an error when the object deletion in tearDown(),'
nl|'\n'
comment|'# the object is added again.'
nl|'\n'
name|'resp'
op|'='
name|'retry'
