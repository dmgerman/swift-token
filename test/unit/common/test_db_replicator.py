...
op|'('
op|'('
string|"'Found /path/to/file for /a%20c%20t when it should be on '"
nl|'\n'
string|"'partition 0; will replicate out and remove.'"
op|','
op|')'
op|','
op|'{'
...
newline|'\n'
nl|'\n'
DECL|member|test_repl_to_node_http_connect_fails
dedent|''
name|'def'
name|'test_repl_to_node_http_connect_fails'
op|'('
name|'self'
op|')'
op|':'
