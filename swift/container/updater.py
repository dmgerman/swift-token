...
op|'('
nl|'\n'
string|"'Container update sweep of %s completed: '"
nl|'\n'
string|"'%.02fs, %s successes, %s failures, %s with no changes'"
nl|'\n'
op|'%'
op|'('
name|'path'
...
newline|'\n'
nl|'\n'
DECL|member|update_once_single_threaded
dedent|''
dedent|''
dedent|''
name|'def'
...
op|'('
nl|'\n'
string|"'Update report sent for %s %s'"
op|'%'
op|'('
name|'container'
op|','
...
op|'('
nl|'\n'
string|"'Update report failed for %s %s'"
op|'%'
op|'('
name|'container'
op|','
