...
newline|'\n'
nl|'\n'
DECL|member|make_fake_ssync_connect
name|'def'
name|'make_fake_ssync_connect'
op|'('
name|'self'
op|','
name|'sender'
op|','
name|'rx_obj_controller'
op|','
name|'device'
op|','
nl|'\n'
...
op|':'
newline|'\n'
comment|'# Strip response head and tail'
nl|'\n'
indent|'            '
name|'while'
name|'True'
...
op|':'
newline|'\n'
comment|'# verify tx and rx files that should be in sync'
nl|'\n'
indent|'        '
name|'for'
name|'o_name'
...
op|':'
newline|'\n'
comment|"# this frag_index should have been sync'd,"
nl|'\n'
...
op|':'
newline|'\n'
comment|"# this frag_index should not have been sync'd,"
nl|'\n'
...
nl|'\n'
comment|'# to the receiver, and that those frag archives are then removed from'
nl|'\n'
comment|'# local node.'
nl|'\n'
indent|'        '
...
op|')'
newline|'\n'
comment|'# fake connection from tx to rx...'
nl|'\n'
name|'self'
op|'.'
name|'sender'
