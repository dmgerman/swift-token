...
op|':'
newline|'\n'
comment|'# Ensure the queue getter gets an empty-string-terminator.'
nl|'\n'
indent|'            '
name|'queue'
op|'.'
...
op|')'
newline|'\n'
comment|'# Whether we get a 416 Requested Range Not Satisfiable or not,'
nl|'\n'
comment|'# we should request a manifest because size of manifest file'
nl|'\n'
comment|'# can be not 0. After checking a manifest, redo the range request'
nl|'\n'
comment|'# on the whole object.'
nl|'\n'
name|'if'
name|'req'
op|'.'
