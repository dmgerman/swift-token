...
newline|'\n'
nl|'\n'
comment|'# FIXME(clayg): this attribute is set after open and affects the'
nl|'\n'
comment|'# behavior of the class (i.e. public interface)'
nl|'\n'
name|'self'
op|'.'
name|'keep_cache'
...
newline|'\n'
nl|'\n'
DECL|member|_get_data_file_size
dedent|''
name|'def'
name|'_get_data_file_size'
op|'('
