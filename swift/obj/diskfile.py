...
op|')'
newline|'\n'
comment|'# TODO ref to durables here'
nl|'\n'
name|'if'
string|"'.durable'"
name|'in'
...
newline|'\n'
nl|'\n'
comment|'# gather info about the valid files to us to open the DiskFile'
nl|'\n'
dedent|''
name|'file_info'
op|'='
...
nl|'\n'
comment|'# .data or .ts, so discard the older .data file'
nl|'\n'
indent|'                '
name|'discard'
op|'('
...
op|':'
newline|'\n'
comment|'# newer .data or .ts already found so discard this'
nl|'\n'
indent|'                '
name|'discard'
op|'('
...
string|'"""\n        Verify that the final combination of on disk files complies with the\n        diskfile contract.\n\n        :param accepted_files: files that have been found and accepted\n        :returns: True if the file combination is compliant, False otherwise\n        """'
newline|'\n'
comment|'# mimic legacy behavior - .meta is ignored when .ts is found'
nl|'\n'
name|'if'
name|'accepted_files'
op|'.'
