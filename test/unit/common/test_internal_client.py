...
op|':'
newline|'\n'
comment|'# basic GET request, only url as kwarg'
nl|'\n'
indent|'        '
name|'request'
op|'.'
...
nl|'\n'
op|'('
string|"'-> 2014-05-27T20:54:11 GET http://127.0.0.1%3Fformat%3Djson 200 '"
nl|'\n'
...
name|'send'
op|'('
string|"'HTTP/1.1 503 Server Error'"
op|')'
newline|'\n'
name|'conn'
op|'.'
...
op|'('
nl|'\n'
string|'"Got %s which probably means the http proxy "'
nl|'\n'
string|'"settings were not used"'
op|'%'
name|'e'
op|')'
newline|'\n'
...
name|'fail'
op|'('
string|"'Unexpected successful response'"
op|')'
newline|'\n'
dedent|''
dedent|''
