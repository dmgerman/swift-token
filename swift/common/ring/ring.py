...
comment|'#'
nl|'\n'
comment|'# Since this is to speed up the finding of handoffs, we only'
nl|'\n'
comment|'# consider devices with at least one partition assigned. This'
nl|'\n'
comment|'# way, a region, zone, or server with no partitions assigned'
nl|'\n'
comment|'# does not count toward our totals, thereby keeping the early'
nl|'\n'
comment|'# bailouts in get_more_nodes() working.'
nl|'\n'
name|'dev_ids_with_parts'
op|'='
name|'set'
op|'('
op|')'
