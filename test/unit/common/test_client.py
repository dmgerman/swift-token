...
op|':'
newline|'\n'
comment|'# before we break json, grab a copy of the orig_dumps function'
nl|'\n'
indent|'            '
name|'_orig_dumps'
op|'='
...
op|':'
newline|'\n'
comment|'# basic test of swift.common.client.json_loads using json.loads'
nl|'\n'
indent|'            '
name|'data'
op|'='
...
op|':'
newline|'\n'
comment|'# even more basic test using a hand encoded json string'
nl|'\n'
indent|'            '
name|'data'
op|'='
