...
newline|'\n'
nl|'\n'
DECL|member|test_container_report
dedent|''
dedent|''
name|'def'
name|'test_container_report'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|fake_container_sync_row
name|'def'
name|'fake_container_sync_row'
op|'('
name|'self'
op|','
name|'row'
...
newline|'\n'
nl|'\n'
DECL|function|fake_object_in_rcontainer
name|'def'
name|'fake_object_in_rcontainer'
op|'('
name|'row'
op|','
name|'sync_to'
...
nl|'\n'
dedent|''
name|'orig_object_in_rcontainer'
op|'='
name|'cs'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# Test the following cases:'
nl|'\n'
comment|"# remote has the same date and a put doesn't take place"
nl|'\n'
comment|"# remote has more up to date copy and a put doesn't take place"
nl|'\n'
comment|'# head_object returns ClientException(404) and a put takes place'
nl|'\n'
comment|"# head_object returns other ClientException put doesn't take place"
nl|'\n'
comment|'# and we get failure'
nl|'\n'
comment|'# head_object returns other Exception put does not take place'
nl|'\n'
comment|'# and we get failure'
nl|'\n'
comment|'# remote returns old copy and a put takes place'
nl|'\n'
name|'test_row'
op|'='
op|'{'
...
newline|'\n'
nl|'\n'
DECL|function|fake_head_object
dedent|''
name|'def'
name|'fake_head_object'
op|'('
op|'*'
name|'args'
op|','
...
op|')'
newline|'\n'
comment|'# No additional put has taken place'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
op|')'
newline|'\n'
comment|'# Additional put has taken place'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
op|')'
newline|'\n'
comment|'# No additional put has taken place, failures increased'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
