...
newline|'\n'
nl|'\n'
DECL|member|test_domain_remap_configured_with_no_prefixes
dedent|''
name|'def'
name|'test_domain_remap_configured_with_no_prefixes'
op|'('
name|'self'
op|')'
op|':'
...
name|'resp'
op|','
string|"'/v1/uuid/c/test'"
op|')'
newline|'\n'
nl|'\n'
DECL|member|test_domain_remap_add_prefix
dedent|''
name|'def'
name|'test_domain_remap_add_prefix'
op|'('
name|'self'
op|')'
op|':'
...
name|'resp'
op|','
string|"'/v1/FOO_uuid/test'"
op|')'
newline|'\n'
nl|'\n'
DECL|member|test_domain_remap_add_prefix_already_there
dedent|''
name|'def'
name|'test_domain_remap_add_prefix_already_there'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_registered_nondefaults
dedent|''
name|'def'
name|'test_registered_nondefaults'
op|'('
name|'self'
op|')'
op|':'
