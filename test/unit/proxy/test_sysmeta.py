...
op|':'
newline|'\n'
comment|'# test fast-post by issuing requests to the proxy app'
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# test post-as-copy by issuing requests to the copy middleware app'
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# check sysmeta is updated by a COPY in same way as user meta by'
nl|'\n'
comment|'# issuing requests to the copy middleware app'
nl|'\n'
indent|'        '
name|'path'
op|'='
...
op|':'
newline|'\n'
comment|'# check sysmeta is updated by a PUT with x-copy-from in same way as'
nl|'\n'
comment|'# user meta by issuing requests to the copy middleware app'
nl|'\n'
indent|'        '
name|'path'
op|'='
