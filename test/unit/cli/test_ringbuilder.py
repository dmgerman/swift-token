...
newline|'\n'
nl|'\n'
DECL|member|assertSystemExit
dedent|''
name|'def'
name|'assertSystemExit'
op|'('
name|'self'
op|','
name|'return_code'
...
op|'='
op|'['
string|'"d0r0z0-127.0.0.1:6200R127.0.0.1:6200/sda1_some meta data"'
op|']'
newline|'\n'
name|'search_values'
op|'='
...
nl|'\n'
comment|"# _set_weight_values doesn't take argv-like arguments"
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
comment|'# Test no devices'
nl|'\n'
comment|"# _set_info_values doesn't take argv-like arguments"
nl|'\n'
indent|'        '
name|'self'
op|'.'
...
op|','
nl|'\n'
string|'"r2z3-127.0.0.1:6200/sda3_some meta data"'
op|','
string|'"3.14159265359"'
op|']'
newline|'\n'
...
op|','
nl|'\n'
string|'"r1z1-127.0.0.1:6200/sda9"'
op|','
string|'"3.14159265359"'
op|','
nl|'\n'
...
op|','
nl|'\n'
string|'"r2z3-2001:0000:1234:0000:0000:C1C0:ABCD:0876:6200"'
nl|'\n'
...
op|','
nl|'\n'
string|'"r0z0-127.0.0.1:6200/sda1_some meta data"'
op|','
string|'"100"'
op|']'
newline|'\n'
...
op|','
nl|'\n'
string|'"z3-127.0.0.1:6200/sde3_some meta data"'
op|','
string|'"3.14159265359"'
op|']'
newline|'\n'
...
op|','
nl|'\n'
string|'"d4r2z3-[2001:0000:1234:0000:0000:C1C0:ABCD:0876]:6200"'
nl|'\n'
...
string|'"reassigned is 1 (0:00:00 remaining)\\n"'
string|'"The overload factor is 0.00%% (0.000000)\\n"'
string|'"Ring file %s.ring.gz not found, probably "'
string|'"it hasn\'t been written yet\\n"'
...
string|'"             0       0     0       127.0.0.1  6200       "'
string|'"127.0.0.1              6200      sda1 100.00"'
string|'"          0 -100.00       some meta data\\n"'
string|'"             1       1     1       127.0.0.2  6201       "'
string|'"127.0.0.2              6201      sda2   0.00"'
string|'"          0    0.00   DEL \\n"'
string|'"             2       2     2       127.0.0.3  6202       "'
string|'"127.0.0.3              6202      sdc3 100.00"'
string|'"          0 -100.00       \\n"'
string|'"             3       3     3       127.0.0.4  6203       "'
string|'"127.0.0.4              6203      sdd4   0.00"'
string|'"          0    0.00       \\n"'
op|'%'
op|'('
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|test_default_ringfile_check
dedent|''
name|'def'
name|'test_default_ringfile_check'
op|'('
name|'self'
op|')'
op|':'
...
dedent|''
dedent|''
name|'ring_not_found_re'
op|'='
name|'re'
op|'.'
name|'compile'
op|'('
string|'"Ring file .*\\.ring\\.gz not found"'
op|')'
newline|'\n'
name|'self'
op|'.'
...
op|')'
newline|'\n'
comment|'# ring file is up-to-date'
nl|'\n'
name|'mock_stdout'
op|'='
name|'six'
...
dedent|''
dedent|''
name|'ring_up_to_date_re'
op|'='
name|'re'
op|'.'
name|'compile'
op|'('
string|'"Ring file .*\\.ring\\.gz is up-to-date"'
op|')'
newline|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# change builder (set weight)'
nl|'\n'
name|'argv'
op|'='
op|'['
...
op|')'
newline|'\n'
comment|'# ring file is obsolete after set_weight'
nl|'\n'
name|'mock_stdout'
op|'='
name|'six'
...
dedent|''
dedent|''
name|'ring_obsolete_re'
op|'='
name|'re'
op|'.'
name|'compile'
op|'('
string|'"Ring file .*\\.ring\\.gz is obsolete"'
op|')'
newline|'\n'
name|'self'
op|'.'
...
op|')'
newline|'\n'
comment|'# ring file up-to-date again'
nl|'\n'
name|'mock_stdout'
op|'='
name|'six'
...
newline|'\n'
nl|'\n'
comment|'# Break ring file e.g. just make it empty'
nl|'\n'
name|'open'
op|'('
string|"'%s.ring.gz'"
...
dedent|''
dedent|''
name|'ring_invalid_re'
op|'='
name|'re'
op|'.'
name|'compile'
op|'('
string|'"Ring file .*\\.ring\\.gz is invalid"'
op|')'
newline|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebalance_resets_time_remaining
dedent|''
name|'def'
name|'test_rebalance_resets_time_remaining'
op|'('
name|'self'
op|')'
op|':'
...
name|'time_path'
op|'='
string|"'swift.common.ring.builder.time'"
newline|'\n'
name|'argv'
op|'='
op|'['
...
newline|'\n'
nl|'\n'
comment|'# first rebalance, should have 1 hour left before next rebalance'
nl|'\n'
name|'time'
op|'+='
number|'3600'
...
newline|'\n'
nl|'\n'
comment|'# min part hours passed, change ring and save for rebalance'
nl|'\n'
dedent|''
name|'ring'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# second rebalance, should have 1 hour left'
nl|'\n'
name|'time'
op|'+='
number|'3600'
...
newline|'\n'
nl|'\n'
DECL|member|test_rebalance_failure_does_not_reset_last_moves_epoch
dedent|''
dedent|''
name|'def'
name|'test_rebalance_failure_does_not_reset_last_moves_epoch'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# min part hours not passed'
nl|'\n'
name|'with'
name|'mock'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# min part hours passed, no partitions need to be moved'
nl|'\n'
name|'with'
name|'mock'
op|'.'
...
string|'"add"'
op|','
string|'"r1z1-127.0.0.1:6200/sdb"'
op|','
string|'"1.0"'
op|']'
newline|'\n'
...
string|'"add"'
op|','
string|'"r1z1-127.0.0.1:6200/sdc"'
op|','
string|'"1.0"'
op|']'
newline|'\n'
