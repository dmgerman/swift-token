...
name|'self'
op|'.'
name|'_prepended_segments'
op|'='
op|'['
op|']'
newline|'\n'
nl|'\n'
DECL|member|prepend_segments
dedent|''
name|'def'
name|'prepend_segments'
op|'('
name|'self'
op|','
name|'new_segs'
...
name|'SegmentError'
op|'('
string|"'Too many unread slo segments in buffer'"
op|')'
newline|'\n'
dedent|''
name|'self'
...
name|'_'
op|'('
string|"'Max LO GET time of %s exceeded.'"
op|')'
op|'%'
name|'self'
op|'.'
...
op|':'
newline|'\n'
comment|'# this segment is a nested slo object. read in the body'
nl|'\n'
comment|'# and add its segments into this slo.'
nl|'\n'
indent|'                    '
name|'try'
op|':'
...
op|'('
nl|'\n'
string|"'Object segment does not match sub-slo: '"
nl|'\n'
...
op|'('
nl|'\n'
string|"'Sub SLO has invalid manifest: %s'"
op|')'
op|'%'
name|'path'
op|')'
...
nl|'\n'
comment|"# case of SegmentError we don't want that and we'd rather"
nl|'\n'
...
nl|'\n'
comment|'# Agreements and this SegmentError indicates the user has'
nl|'\n'
