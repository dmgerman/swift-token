...
name|'execute'
op|'('
string|"'SELECT noaccess FROM account LIMIT 1'"
op|')'
newline|'\n'
dedent|''
name|'except'
...
op|')'
op|'=='
string|"'no such column: noaccess'"
op|':'
newline|'\n'
indent|'                '
name|'self'
...
op|'('
nl|'\n'
string|"'ALTER TABLE account ADD COLUMN noaccess TEXT'"
op|')'
newline|'\n'
dedent|''
dedent|''
...
op|')'
newline|'\n'
comment|'# X-Auth-User: account:user,account,cfaccount'
nl|'\n'
dedent|''
name|'return'
name|'HTTPNoContent'
