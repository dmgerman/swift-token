...
newline|'\n'
indent|'        '
string|'""" Test swift.common.utils.backward """'
newline|'\n'
nl|'\n'
...
newline|'\n'
indent|'        '
string|'""" Test swift.common.utils.validate_device_partition """'
newline|'\n'
name|'utils'
op|'.'
...
op|':'
newline|'\n'
comment|'# use mkstemp to get a file that is definitely on disk'
nl|'\n'
indent|'        '
name|'with'
name|'NamedTemporaryFile'
