...
indent|'                '
name|'pass'
comment|"# real spawn won't do anything but pollute logs"
newline|'\n'
dedent|''
dedent|''
name|'object_server'
...
newline|'\n'
nl|'\n'
DECL|member|test_expect_on_multiphase_put
dedent|''
name|'def'
name|'test_expect_on_multiphase_put'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# Test 2-phase commit conversation - end of 1st phase marked'
nl|'\n'
comment|'# by 100-continue response from the object server, with a'
nl|'\n'
comment|'# successful 2nd phase marked by the presence of a .durable'
nl|'\n'
comment|'# file along with .data file in the object data directory'
nl|'\n'
indent|'        '
name|'test_data'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_multiphase_put_no_metadata_footer
dedent|''
name|'def'
name|'test_multiphase_put_no_metadata_footer'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Test 2-phase commit conversation, with no metadata footer'
nl|'\n'
comment|'# at the end of object data - end of 1st phase marked'
nl|'\n'
comment|'# by 100-continue response from the object server, with a'
nl|'\n'
comment|'# successful 2nd phase marked by the presence of a .durable'
...
comment|'# file along with .data file in the object data directory'
nl|'\n'
comment|'# (No metadata footer case)'
nl|'\n'
indent|'        '
name|'test_data'
op|'='
...
newline|'\n'
nl|'\n'
DECL|class|PickyWsgiStringIO
dedent|''
dedent|''
name|'class'
name|'PickyWsgiStringIO'
op|'('
name|'WsgiStringIO'
op|')'
op|':'
...
comment|'# Test 2-phase commit conversation - end of 1st phase marked'
nl|'\n'
comment|'# by 100-continue response from the object server, with 2nd'
nl|'\n'
comment|'# phase commit confirmation being received corrupt'
nl|'\n'
indent|'        '
name|'test_data'
op|'='
