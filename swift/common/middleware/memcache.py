...
op|':'
newline|'\n'
comment|"# if memcache.conf exists we'll start with those base options"
nl|'\n'
indent|'                '
name|'try'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# while memcache.conf options are the base for the memcache'
nl|'\n'
comment|'# middleware, if you set the same option also in the filter'
nl|'\n'
comment|'# section of the proxy config it is more specific.'
nl|'\n'
dedent|''
dedent|''
dedent|''
