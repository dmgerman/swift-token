...
newline|'\n'
nl|'\n'
comment|'# compare ring file against builder file'
nl|'\n'
name|'if'
name|'not'
name|'exists'
...
name|'print'
op|'('
string|"'Ring file %s not found, '"
nl|'\n'
string|"'probably it hasn\\'t been written yet'"
op|'%'
name|'ring_file'
op|')'
newline|'\n'
...
name|'print'
op|'('
string|"'Ring file %s is invalid: %r'"
op|'%'
op|'('
name|'ring_file'
op|','
...
name|'print'
op|'('
string|"'Ring file %s is up-to-date'"
op|'%'
name|'ring_file'
op|')'
newline|'\n'
...
name|'print'
op|'('
string|"'Ring file %s is obsolete'"
op|'%'
name|'ring_file'
op|')'
newline|'\n'
