...
newline|'\n'
nl|'\n'
comment|"# While it's true that any() will short-circuit, this doesn't affect"
nl|'\n'
comment|'# the timing-attack resistance since the only way this will'
nl|'\n'
...
op|')'
newline|'\n'
comment|"# this is probably just paranoia, I couldn't acctually get a"
nl|'\n'
