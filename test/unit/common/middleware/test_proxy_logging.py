...
op|')'
newline|'\n'
name|'is_container_or_object_req'
op|'='
name|'True'
newline|'\n'
dedent|''
...
op|')'
newline|'\n'
name|'got_metrics_values_and_kwargs'
op|'='
op|'['
op|'('
name|'usc'
...
op|']'
newline|'\n'
name|'exp_metrics_values_and_kwargs'
op|'='
op|'['
op|'('
name|'emv'
...
op|':'
newline|'\n'
comment|'# Object operations also return stats by policy'
nl|'\n'
comment|'# In this case, the value needs to match the timing for GET'
nl|'\n'
indent|'                    '
name|'self'
op|'.'
name|'assertTiming'
op|'('
string|"'%s.policy.0.GET.321.timing'"
op|'%'
name|'exp_type'
op|','
nl|'\n'
...
nl|'\n'
op|'('
string|"'object.policy.0.GET.321.xfer'"
op|','
nl|'\n'
number|'4'
op|'+'
...
newline|'\n'
nl|'\n'
comment|'# GET Repeat the test above, but with a non-existent policy'
nl|'\n'
comment|'# Do this only for object types'
nl|'\n'
dedent|''
name|'if'
name|'exp_type'
...
op|')'
newline|'\n'
comment|'# No results returned for the non-existent policy'
nl|'\n'
name|'self'
op|'.'
name|'assertUpdateStats'
...
op|':'
newline|'\n'
comment|'# Object operations also return stats by policy In this'
nl|'\n'
comment|'# case, the value needs to match the timing for PUT.'
nl|'\n'
indent|'                    '
name|'self'
op|'.'
name|'assertTiming'
op|'('
string|"'%s.policy.0.PUT.314.timing'"
op|'%'
nl|'\n'
name|'exp_type'
op|','
...
nl|'\n'
op|'('
string|"'object.policy.0.PUT.314.xfer'"
op|','
number|'6'
op|'+'
number|'8'
...
newline|'\n'
nl|'\n'
comment|'# PUT Repeat the test above, but with a non-existent policy'
nl|'\n'
comment|'# Do this only for object types'
nl|'\n'
dedent|''
...
nl|'\n'
op|'('
string|"'object.policy.0.PUT.200.xfer'"
op|','
nl|'\n'
name|'len'
op|'('
...
newline|'\n'
nl|'\n'
comment|'# Using a non-existent policy'
nl|'\n'
name|'app'
op|'='
name|'proxy_logging'
...
newline|'\n'
nl|'\n'
DECL|member|test_upload_size_no_policy
dedent|''
name|'def'
name|'test_upload_size_no_policy'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_iterator_closing
dedent|''
name|'def'
name|'test_iterator_closing'
op|'('
name|'self'
op|')'
op|':'
...
op|'('
nl|'\n'
comment|'# test the "while not chunk: chunk = next(iterator)"'
nl|'\n'
name|'body'
op|'='
op|'['
...
newline|'\n'
nl|'\n'
comment|'# Default - reveal_sensitive_prefix is 16'
nl|'\n'
...
newline|'\n'
nl|'\n'
comment|'# No effective limit on auth token'
nl|'\n'
name|'app'
op|'='
name|'proxy_logging'
...
newline|'\n'
nl|'\n'
DECL|member|test_policy_index
dedent|''
name|'def'
name|'test_policy_index'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Policy index can be specified by X-Backend-Storage-Policy-Index'
nl|'\n'
comment|'# in the request header for object API'
nl|'\n'
indent|'        '
name|'app'
op|'='
...
comment|'# Policy index can be specified by X-Backend-Storage-Policy-Index'
nl|'\n'
comment|'# in the response header for container API'
nl|'\n'
name|'app'
op|'='
name|'proxy_logging'
