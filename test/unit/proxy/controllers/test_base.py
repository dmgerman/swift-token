...
newline|'\n'
nl|'\n'
comment|'# Run the above tests again, but this time with concurrent_reads'
nl|'\n'
comment|'# turned on'
nl|'\n'
name|'policy'
...
op|')'
newline|'\n'
comment|'# NOTE: We are using slow_connect of fake_http_connect as using'
nl|'\n'
comment|'# a concurrency of 0 when mocking the connection is a little too'
nl|'\n'
comment|'# fast for eventlet. Network i/o will make this fine, but mocking'
nl|'\n'
comment|'# it seems is too instantaneous.'
nl|'\n'
name|'with'
name|'patch'
op|'('
...
newline|'\n'
nl|'\n'
DECL|member|test_range_fast_forward_after_data_timeout
dedent|''
name|'def'
name|'test_range_fast_forward_after_data_timeout'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|"# We get a 200 and learn that it's a 1000-byte object, but receive 0"
nl|'\n'
comment|'# bytes of data, so then we get a new node, fast_forward(0), and'
nl|'\n'
comment|'# send out a new request. That new request must be for all 1000'
nl|'\n'
comment|'# bytes.'
nl|'\n'
name|'handler'
...
newline|'\n'
nl|'\n'
comment|'# Same story as above, but a 1-byte object so we can have our byte'
nl|'\n'
comment|'# indices be 0.'
nl|'\n'
name|'handler'
op|'='
name|'GetOrHeadHandler'
...
newline|'\n'
nl|'\n'
DECL|member|test_client_chunk_size_resuming_chunked
dedent|''
name|'def'
name|'test_client_chunk_size_resuming_chunked'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
nl|'\n'
DECL|class|TestChunkedSource
indent|'        '
name|'class'
name|'TestChunkedSource'
op|'('
name|'object'
op|')'
op|':'
