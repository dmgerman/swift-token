...
newline|'\n'
indent|'    '
string|'"""Extract storage stats from account databases on the account\n    storage nodes\n    """'
newline|'\n'
nl|'\n'
...
op|':'
newline|'\n'
comment|'#TODO: handle a counter in the filename to prevent overwrites?'
nl|'\n'
indent|'        '
name|'src_filename'
op|'='
