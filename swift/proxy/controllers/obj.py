...
name|'self'
op|'.'
name|'decode_segments_from_fragments'
op|'('
op|')'
newline|'\n'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# plain GET; just yield up segments'
nl|'\n'
indent|'            '
name|'for'
name|'seg'
...
op|'('
string|'"multi-range GETs not done yet"'
op|')'
newline|'\n'
nl|'\n'
dedent|''
...
op|':'
newline|'\n'
comment|'# Suffix byte ranges (i.e. requests for the last N bytes of'
nl|'\n'
comment|'# an object) are likely to end up not on a segment boundary.'
nl|'\n'
indent|'                '
name|'client_range_len'
op|'='
name|'client_end'
newline|'\n'
name|'client_start'
...
newline|'\n'
nl|'\n'
comment|'# may be mid-segment; if it is, then everything up to the'
nl|'\n'
comment|'# first segment boundary is garbage, and is discarded before'
nl|'\n'
comment|'# ever getting into this function.'
nl|'\n'
name|'unaligned_segment_start'
op|'='
name|'max'
op|'('
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|decode_segments_from_fragments
dedent|''
dedent|''
dedent|''
name|'def'
...
op|':'
newline|'\n'
comment|"# If these aren't all for the same object, then error out so"
nl|'\n'
comment|"# at least the client doesn't get garbage. We can do a lot"
nl|'\n'
comment|"# better here with more work, but this'll work for now."
nl|'\n'
indent|'                '
name|'found_obj_etags'
op|'='
name|'set'
op|'('
nl|'\n'
...
op|'('
nl|'\n'
string|'"Returning 503 for %s; found too many etags (%s)"'
op|','
nl|'\n'
name|'req'
op|'.'
...
newline|'\n'
nl|'\n'
comment|"# we found enough pieces to decode the object, so now let's"
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_fix_response_headers
dedent|''
name|'def'
name|'_fix_response_headers'
op|'('
...
nl|'\n'
comment|'# if there are enough 100-continue acknowledgements'
nl|'\n'
indent|'                '
name|'if'
name|'self'
...
nl|'\n'
comment|'# one exists, the reconstructor will spread it around. Thus, we'
nl|'\n'
comment|"# don't require as many .durable files to be successfully"
nl|'\n'
comment|'# written as we do fragment archives in order to call the PUT a'
nl|'\n'
comment|'# success.'
nl|'\n'
name|'min_conns'
