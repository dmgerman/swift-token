...
newline|'\n'
nl|'\n'
DECL|function|mock_err_logger
name|'def'
name|'mock_err_logger'
op|'('
name|'err'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|mock_direct_delete_object
dedent|''
name|'def'
name|'mock_direct_delete_object'
op|'('
name|'node'
op|','
name|'part'
...
name|'resp'
op|'='
string|'"Unable to delete object"'
newline|'\n'
name|'raise'
name|'HTTPException'
op|'('
...
name|'patch'
op|'('
string|"'swift.common.direct_client.direct_delete_object'"
op|','
nl|'\n'
name|'mock_direct_delete_object'
op|')'
