...
newline|'\n'
indent|'    '
string|'"""Connection pool for Memcache Connections"""'
newline|'\n'
nl|'\n'
...
op|':'
newline|'\n'
comment|'# call the patched .get() if eventlet is older than 0.9.17'
nl|'\n'
indent|'            '
name|'if'
name|'StrictVersion'
...
op|':'
newline|'\n'
comment|'# "invalid" version number or otherwise error parsing version'
nl|'\n'
indent|'            '
name|'pass'
newline|'\n'
...
newline|'\n'
nl|'\n'
comment|'# The following method is from eventlet post 0.9.16. This version'
nl|'\n'
comment|"# properly keeps track of pool size accounting, and therefore doesn't"
nl|'\n'
comment|'# let the pool grow without bound. This patched version is the result'
nl|'\n'
comment|'# of commit f5e5b2bda7b442f0262ee1084deefcc5a1cc0694 in eventlet and is'
nl|'\n'
comment|'# documented at https://bitbucket.org/eventlet/eventlet/issue/91'
nl|'\n'
DECL|member|_upstream_fixed_get
dedent|''
name|'def'
name|'_upstream_fixed_get'
op|'('
...
newline|'\n'
indent|'        '
string|'"""Return an item from the pool, when one is available.  This may\n        cause the calling greenthread to block.\n        """'
newline|'\n'
name|'if'
name|'self'
op|'.'
...
op|')'
newline|'\n'
comment|'# This was really supposed to be "except:" but ran afoul of the'
nl|'\n'
comment|'# H201 check, which does not implement the "noqa" exception.  Once'
nl|'\n'
comment|'# that\'s fixed, the except here can be changed to "except:  # noqa"'
nl|'\n'
dedent|''
name|'except'
op|'('
...
nl|'\n'
comment|'# A new connection will be created the next time it is retreived'
nl|'\n'
indent|'            '
name|'self'
op|'.'
...
name|'warn'
op|'('
string|'"parameter timeout has been deprecated, use time"'
op|')'
newline|'\n'
dedent|''
name|'timeout'
