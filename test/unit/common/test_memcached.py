...
newline|'\n'
nl|'\n'
comment|'# Ensure we exercise the backported-for-pre-eventlet-version-0.9.17 get()'
nl|'\n'
comment|"# code, even if the executing eventlet's version is already newer."
nl|'\n'
dedent|''
dedent|''
op|'@'
...
name|'memcached'
op|','
string|"'eventlet_version'"
op|','
string|"'0.9.16'"
op|')'
newline|'\n'
DECL|member|test_connection_pooling_pre_0_9_17
name|'def'
name|'test_connection_pooling_pre_0_9_17'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|function|_slow_yielding_connector
name|'def'
name|'_slow_yielding_connector'
op|'('
name|'addr'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# If POOL_SIZE is not small enough relative to USER_COUNT, the'
nl|'\n'
comment|'# "free_items" business in the eventlet.pools.Pool will cause'
nl|'\n'
comment|'# spurious failures below.  I found these values to work well on a'
nl|'\n'
comment|'# VM running in VirtualBox on a late 2013 Retina MacbookPro:'
nl|'\n'
name|'POOL_SIZE'
op|'='
number|'5'
...
op|')'
newline|'\n'
comment|'# This was really supposed to be "except:" but ran afoul'
nl|'\n'
comment|'# of the H201 check, which does not implement the "noqa"'
nl|'\n'
comment|"# exception.  Once that's fixed, the except here can be"
nl|'\n'
comment|'# changed to "except: # noqa"'
nl|'\n'
dedent|''
name|'except'
op|'('
...
newline|'\n'
nl|'\n'
comment|'# make a bunch of requests "at the same time"'
nl|'\n'
dedent|''
name|'p'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# If the except block after the "created = self.create()" call'
nl|'\n'
comment|"# doesn't correctly decrement self.current_size, this test will"
nl|'\n'
comment|'# fail by having some number less than POOL_SIZE connections (in my'
nl|'\n'
comment|'# testing, anyway).'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
comment|'# Subsequent requests should get and use the existing'
nl|'\n'
comment|'# connections, not creating any more.'
nl|'\n'
name|'for'
name|'i'
name|'in'
...
newline|'\n'
nl|'\n'
comment|'# hand out a couple slow connection'
nl|'\n'
name|'mock_conn'
op|'='
name|'MagicMock'
...
newline|'\n'
nl|'\n'
comment|'# so far so good, everyone is still waiting'
nl|'\n'
name|'sleep'
op|'('
number|'0'
...
newline|'\n'
nl|'\n'
comment|"# but they won't wait longer than pool_timeout"
nl|'\n'
name|'mock_conn'
op|'='
name|'MagicMock'
