...
nl|'\n'
comment|'# value of local:http://127.0.0.1:8080/v1. But, often the url given to'
nl|'\n'
comment|'# the user needs to be different than the url used by Swauth to'
nl|'\n'
comment|"# create/delete accounts. So there's a more complex format of"
nl|'\n'
comment|'# cluster_name::url::url, such as'
nl|'\n'
comment|'# local::https://public.com:8080/v1::http://private.com:8080/v1.'
nl|'\n'
comment|'# The double colon is what sets the two apart.'
nl|'\n'
name|'if'
string|"'::'"
name|'in'
