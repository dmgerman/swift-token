...
newline|'\n'
nl|'\n'
comment|"# Older memcache values (should be treated as if they aren't there):"
nl|'\n'
comment|'# 0 = no responses, 200 = found, 404 = not found, -1 = mixed responses'
nl|'\n'
comment|'# Newer memcache values:'
nl|'\n'
comment|'# [older status value from above, read acl, write acl]'
nl|'\n'
name|'cache_value'
op|'='
name|'self'
...
op|')'
newline|'\n'
comment|'#TODO : David - does this need to be using the '
nl|'\n'
comment|'# get_container_memcache_key function????'
nl|'\n'
dedent|''
name|'self'
op|'.'
