...
nl|'\n'
nl|'\n'
comment|"# Hack to work around Eventlet's tpool not catching and reraising Timeouts. We"
nl|'\n'
comment|"# return the Timeout, Timeout if it's raised, the caller looks for it and"
nl|'\n'
comment|'# reraises it if found.'
nl|'\n'
DECL|function|tpooled_get_hashes
dedent|''
dedent|''
name|'def'
name|'tpooled_get_hashes'
op|'('
op|'*'
name|'args'
op|','
...
op|')'
newline|'\n'
comment|'# See tpooled_get_hashes "Hack".'
nl|'\n'
name|'if'
name|'isinstance'
op|'('
...
op|':'
newline|'\n'
comment|'# If this throws StopIterator it will be caught way below'
nl|'\n'
indent|'                '
name|'node'
op|'='
...
name|'_'
op|'('
string|"'Exception decoding recon cache'"
op|')'
op|')'
newline|'\n'
dedent|''
