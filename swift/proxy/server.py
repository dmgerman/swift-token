...
op|'('
nl|'\n'
string|"'%s?prefix=%s&format=json&marker=%s'"
op|'%'
nl|'\n'
op|'('
name|'path'
...
nl|'\n'
comment|'# we were actually requesting a manifest and then redo'
nl|'\n'
comment|'# the range request on the whole object.'
nl|'\n'
name|'if'
name|'resp'
op|'.'
...
op|':'
newline|'\n'
comment|'# set raw_listing so that the actual object is deleted'
nl|'\n'
indent|'                '
name|'raw_listing'
op|'='
...
op|')'
newline|'\n'
comment|'# done with this transaction'
nl|'\n'
name|'self'
op|'.'
name|'access_logger'
