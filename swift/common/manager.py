...
newline|'\n'
indent|'    '
string|'"""Send signal to process group\n\n    : param pid: process id\n    : param sig: signal to send\n    """'
newline|'\n'
comment|'# Negative PID means process group'
nl|'\n'
name|'os'
op|'.'
name|'kill'
...
name|'_'
op|'('
string|'"%(server)s (%(pid)s) appears to have stopped"'
op|')'
op|'%'
nl|'\n'
op|'{'
...
name|'_'
op|'('
string|"'Waited %(kill_wait)s seconds for %(server)s '"
nl|'\n'
string|"'to die; killing'"
op|')'
op|'%'
nl|'\n'
op|'{'
...
op|')'
newline|'\n'
comment|'# Send SIGKILL to all remaining pids'
nl|'\n'
name|'for'
name|'pid'
name|'in'
...
name|'_'
op|'('
string|"'Signal %(server)s  pid: %(pid)s  signal: '"
nl|'\n'
string|"'%(signal)s'"
op|')'
op|'%'
...
op|')'
newline|'\n'
comment|'# Send SIGKILL to process group'
nl|'\n'
name|'try'
op|':'
newline|'\n'
...
op|':'
newline|'\n'
comment|'# PID died before kill_group can take action?'
nl|'\n'
indent|'                            '
name|'if'
name|'e'
...
name|'_'
op|'('
string|"'Unable to locate config number %(number)s for'"
nl|'\n'
string|"' %(server)s'"
op|')'
op|'%'
...
name|'_'
op|'('
string|'"%(server)s #%(number)d not running (%(conf)s)"'
op|')'
op|'%'
nl|'\n'
op|'{'
...
name|'_'
op|'('
string|'"%(server)s running (%(pid)s - %(conf)s)"'
op|')'
op|'%'
nl|'\n'
op|'{'
...
name|'_'
op|'('
string|'"%(server)s running (%(pid)s - %(pid_file)s)"'
op|')'
op|'%'
nl|'\n'
op|'{'
