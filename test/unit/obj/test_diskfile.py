...
newline|'\n'
nl|'\n'
DECL|member|_test_cleanup_ondisk_files_files
dedent|''
dedent|''
dedent|''
name|'def'
name|'_test_cleanup_ondisk_files_files'
op|'('
name|'self'
op|','
name|'scenarios'
...
nl|'\n'
comment|'# same scenarios as passed to _test_cleanup_ondisk_files_files'
nl|'\n'
indent|'        '
name|'for'
name|'test'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_reclaim_non_data_files
dedent|''
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_reclaim_non_data_files'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
comment|'# fresh .meta not reclaimed even if isolated'
nl|'\n'
op|'['
op|'('
string|"'%s.meta'"
...
nl|'\n'
nl|'\n'
comment|'# fresh .meta not reclaimed when tombstone is reclaimed'
nl|'\n'
op|'['
op|'('
string|"'%s.meta'"
...
nl|'\n'
nl|'\n'
comment|'# stale isolated .meta is reclaimed'
nl|'\n'
op|'['
op|'('
string|"'%s.meta'"
...
nl|'\n'
nl|'\n'
comment|'# stale .meta is reclaimed along with tombstone'
nl|'\n'
op|'['
op|'('
string|"'%s.meta'"
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_reclaim_with_data_files
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_reclaim_with_data_files'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
nl|'\n'
comment|'# .meta not reclaimed if there is a .data file'
nl|'\n'
op|'['
op|'('
string|"'%s.meta'"
...
op|')'
newline|'\n'
comment|'# note: not calling self._test_cleanup_ondisk_files_files(scenarios, 0)'
nl|'\n'
...
nl|'\n'
nl|'\n'
comment|'# .meta not reclaimed if there is durable data'
nl|'\n'
op|'['
op|'('
string|"'%s.meta'"
...
nl|'\n'
nl|'\n'
comment|'# stale .meta reclaimed along with stale non-durable .data'
nl|'\n'
op|'['
op|'('
string|"'%s.meta'"
...
nl|'\n'
nl|'\n'
comment|'# stale .meta reclaimed along with stale .durable'
nl|'\n'
op|'['
op|'('
string|"'%s.meta'"
...
newline|'\n'
nl|'\n'
DECL|member|test_commit_ignores_cleanup_ondisk_files_error
dedent|''
dedent|''
dedent|''
name|'def'
name|'test_commit_ignores_cleanup_ondisk_files_error'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# Check OSError from cleanup_ondisk_files is caught and ignored'
nl|'\n'
indent|'            '
name|'mock_cleanup'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_number_calls_to_cleanup_ondisk_files_during_create
dedent|''
dedent|''
name|'def'
name|'test_number_calls_to_cleanup_ondisk_files_during_create'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# Check how many calls are made to cleanup_ondisk_files, and when,'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_number_calls_to_cleanup_ondisk_files_during_delete
dedent|''
dedent|''
dedent|''
dedent|''
name|'def'
name|'test_number_calls_to_cleanup_ondisk_files_during_delete'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_error_in_cleanup_ondisk_files
dedent|''
name|'def'
name|'test_error_in_cleanup_ondisk_files'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|check_cleanup_ondisk_files
dedent|''
name|'def'
name|'check_cleanup_ondisk_files'
op|'('
name|'self'
op|','
name|'policy'
...
newline|'\n'
nl|'\n'
comment|'# cleanup_ondisk_files tests - behaviors'
nl|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_purge_data_newer_ts
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_purge_data_newer_ts'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_purge_expired_ts
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_purge_expired_ts'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_purge_ts_newer_data
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_purge_ts_newer_data'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_purge_older_ts
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_purge_older_ts'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_keep_meta_data_purge_ts
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_keep_meta_data_purge_ts'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_keep_one_ts
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_keep_one_ts'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_multi_data_file
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_multi_data_file'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_keeps_one_datafile
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_keeps_one_datafile'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_keep_one_meta
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_keep_one_meta'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_only_meta
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_only_meta'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_ignore_orphaned_ts
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_ignore_orphaned_ts'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_purge_old_data_only
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_purge_old_data_only'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_purge_old_ts
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_purge_old_ts'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_keep_isolated_meta_purge_old_ts
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_keep_isolated_meta_purge_old_ts'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# A single old .ts file will be removed despite presence of a .meta'
nl|'\n'
indent|'            '
name|'old_float'
op|'='
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_keep_single_old_data
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_keep_single_old_data'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_drops_isolated_durable
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_drops_isolated_durable'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_purges_single_old_meta
dedent|''
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_purges_single_old_meta'
op|'('
name|'self'
op|')'
op|':'
...
op|':'
newline|'\n'
comment|'# A single old .meta file will be removed'
nl|'\n'
indent|'            '
name|'old_float'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# cleanup_ondisk_files tests - error handling'
nl|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_hsh_path_enoent
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_hsh_path_enoent'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_hsh_path_other_oserror
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_hsh_path_other_oserror'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_reclaim_tombstone_remove_file_error
dedent|''
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_reclaim_tombstone_remove_file_error'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_cleanup_ondisk_files_older_remove_file_error
dedent|''
dedent|''
name|'def'
name|'test_cleanup_ondisk_files_older_remove_file_error'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_hash_suffix_one_reclaim_tombstone_and_one_meta
dedent|''
dedent|''
name|'def'
name|'test_hash_suffix_one_reclaim_tombstone_and_one_meta'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# An isolated meta file can happen if a tombstone is replicated to a'
nl|'\n'
comment|'# node with a newer meta file but older data file, and the tombstone is'
nl|'\n'
comment|'# subsequently reclaimed. The meta file will be ignored when the'
nl|'\n'
comment|'# diskfile is opened so the effective state of the disk files is'
nl|'\n'
comment|'# equivalent to having no files.'
nl|'\n'
indent|'        '
name|'for'
name|'policy'
...
op|')'
newline|'\n'
comment|"# scale back the df manager's reclaim age a bit"
nl|'\n'
name|'df_mgr'
op|'.'
name|'reclaim_age'
...
number|'1000'
newline|'\n'
comment|"# write a tombstone that's just a *little* older than reclaim time"
nl|'\n'
name|'df'
op|'.'
name|'delete'
...
op|')'
newline|'\n'
comment|"# write a meta file that's not quite so old"
nl|'\n'
name|'ts_meta'
op|'='
name|'Timestamp'
...
op|')'
newline|'\n'
comment|'# the tombstone is reclaimed, the meta file remains, the suffix'
nl|'\n'
comment|'# hash is not updated BUT the suffix dir cannot be deleted so'
nl|'\n'
comment|'# a suffix hash equal to hash of empty string is reported.'
nl|'\n'
comment|'# TODO: this is not same result as if the meta file did not exist!'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
...
newline|'\n'
nl|'\n'
comment|"# scale back the df manager's reclaim age even more - call to"
nl|'\n'
comment|'# get_hashes does not trigger reclaim because the suffix has'
nl|'\n'
comment|'# MD5_OF_EMPTY_STRING in hashes.pkl'
nl|'\n'
name|'df_mgr'
op|'.'
name|'reclaim_age'
...
newline|'\n'
nl|'\n'
comment|'# call get_hashes with recalculate = [suffix] and the suffix dir'
nl|'\n'
comment|'# gets re-hashed so the .meta if finally reclaimed.'
nl|'\n'
name|'hashes'
op|'='
name|'df_mgr'
...
newline|'\n'
nl|'\n'
DECL|member|test_hash_suffix_cleanup_ondisk_files_enotdir_quarantined
dedent|''
dedent|''
name|'def'
name|'test_hash_suffix_cleanup_ondisk_files_enotdir_quarantined'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_hash_suffix_cleanup_ondisk_files_other_oserror
dedent|''
dedent|''
name|'def'
name|'test_hash_suffix_cleanup_ondisk_files_other_oserror'
op|'('
name|'self'
op|')'
op|':'
...
nl|'\n'
comment|'# make the cleanup_ondisk_files raise an exception'
nl|'\n'
indent|'                    '
name|'raise'
name|'OSError'
