...
op|','
nl|'\n'
comment|'# Reseller admin user (needs reseller_admin_role)'
nl|'\n'
string|"'account6'"
op|':'
string|"'test6'"
...
newline|'\n'
nl|'\n'
comment|'# If an env var explicitly specifies the proxy-server object_post_as_copy'
nl|'\n'
comment|'# option then use its value, otherwise leave default config unchanged.'
nl|'\n'
...
op|'('
nl|'\n'
string|"'SWIFT_TEST_IN_PROCESS_OBJECT_POST_AS_COPY'"
op|')'
newline|'\n'
name|'if'
name|'object_post_as_copy'
...
name|'_debug'
op|'('
string|"'Setting object_post_as_copy to %r'"
op|'%'
name|'object_post_as_copy'
op|')'
newline|'\n'
...
name|'True'
newline|'\n'
comment|'# else... leave in_process value unchanged. It may be that'
nl|'\n'
comment|'# setup_package is called twice, in which case in_process_setup may'
nl|'\n'
comment|'# have loaded config before we reach here a second time, so the'
nl|'\n'
comment|'# existence of config is not reliable to determine that in_process'
nl|'\n'
comment|"# should be False. Anyway, it's default value is False."
nl|'\n'
dedent|''
dedent|''
name|'else'
...
op|'('
nl|'\n'
string|"'SKIPPING FUNCTIONAL TESTS DUE TO NO CONFIG FOR RESELLER ADMIN'"
op|','
nl|'\n'
name|'file'
op|'='
