...
string|"'Object'"
newline|'\n'
DECL|variable|max_slo_recusion_depth
name|'max_slo_recusion_depth'
op|'='
number|'10'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_slo_listing_obj_iter
dedent|''
dedent|''
name|'def'
name|'_slo_listing_obj_iter'
op|'('
name|'self'
op|','
name|'incoming_req'
...
op|'('
nl|'\n'
string|'"Invalid path to whole SLO manifest: %s"'
op|'%'
nl|'\n'
name|'new_req'
op|'.'
