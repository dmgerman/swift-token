...
newline|'\n'
nl|'\n'
DECL|member|test_multiple_duplicate_device_assignment
dedent|''
name|'def'
name|'test_multiple_duplicate_device_assignment'
op|'('
name|'self'
op|')'
op|':'
...
comment|'#                    |'
nl|'\n'
comment|'#      this sort of thing worked already'
nl|'\n'
op|']'
newline|'\n'
comment|'# fix up bookkeeping'
...
newline|'\n'
nl|'\n'
DECL|member|test_reduce_replicas_after_remove_device
dedent|''
name|'def'
name|'test_reduce_replicas_after_remove_device'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_add_dev_delete_first_n
dedent|''
name|'def'
name|'_add_dev_delete_first_n'
op|'('
name|'self'
op|','
name|'add_dev_count'
...
newline|'\n'
nl|'\n'
DECL|member|test_reuse_of_dev_holes_without_id
dedent|''
name|'def'
name|'test_reuse_of_dev_holes_without_id'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# try with contiguous holes at beginning'
nl|'\n'
indent|'        '
name|'add_dev_count'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# try with non-contiguous holes'
nl|'\n'
comment|'# [0, 1, None, 3, 4, None]'
nl|'\n'
name|'rb2'
op|'='
name|'ring'
...
op|')'
newline|'\n'
comment|'# add a new one (without reusing a hole)'
nl|'\n'
name|'third'
op|'='
name|'rb2'
...
newline|'\n'
nl|'\n'
DECL|member|test_reuse_of_dev_holes_with_id
dedent|''
name|'def'
name|'test_reuse_of_dev_holes_with_id'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# add specifying id'
nl|'\n'
name|'exp_new_dev_id'
op|'='
number|'2'
newline|'\n'
comment|'# [dev, dev, None, dev, dev, None]'
nl|'\n'
name|'try'
op|':'
newline|'\n'
...
name|'fail'
op|'('
string|'"device hole not reused"'
op|')'
newline|'\n'
nl|'\n'
DECL|member|test_increase_partition_power
dedent|''
dedent|''
name|'def'
name|'test_increase_partition_power'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|'# add more devices than replicas to the ring'
nl|'\n'
name|'for'
name|'i'
name|'in'
...
newline|'\n'
nl|'\n'
comment|"# Let's save the ring, and get the nodes for an object"
nl|'\n'
name|'ring_file'
op|'='
name|'os'
...
newline|'\n'
nl|'\n'
comment|'# make sure there is always the same device assigned to every pair of'
nl|'\n'
comment|'# partitions'
nl|'\n'
name|'for'
...
newline|'\n'
nl|'\n'
comment|'# same for last_part moves'
nl|'\n'
dedent|''
dedent|''
name|'for'
...
op|')'
newline|'\n'
comment|'# Due to the increased partition power, the partition each object'
nl|'\n'
comment|'# is assigned to has changed. If the old partition was X, it will'
nl|'\n'
comment|'# now be either located in 2*X or 2*X+1'
nl|'\n'
name|'self'
op|'.'
name|'assertTrue'
...
newline|'\n'
nl|'\n'
comment|'# Importantly, we expect the objects to be placed on the same'
nl|'\n'
comment|'# nodes after increasing the partition power'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
