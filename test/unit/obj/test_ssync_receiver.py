...
op|')'
newline|'\n'
DECL|member|test_MISSING_CHECK_missing_durable
name|'def'
name|'test_MISSING_CHECK_missing_durable'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
comment|"# make rx disk file but don't commit it, so .durable is missing"
nl|'\n'
name|'ts1'
op|'='
name|'next'
...
newline|'\n'
nl|'\n'
comment|'# make a request - expect no data to be wanted'
nl|'\n'
name|'req'
op|'='
name|'swob'
...
name|'patch'
op|'('
string|"'swift.obj.diskfile.ECDiskFileWriter.commit'"
op|')'
newline|'\n'
DECL|member|test_MISSING_CHECK_missing_durable_but_commit_fails
name|'def'
name|'test_MISSING_CHECK_missing_durable_but_commit_fails'
op|'('
name|'self'
op|','
name|'mock_commit'
...
newline|'\n'
nl|'\n'
comment|'# make a request with commit disabled - expect data to be wanted'
nl|'\n'
name|'req'
op|'='
name|'swob'
...
newline|'\n'
nl|'\n'
comment|'# make a request with commit raising error - expect data to be wanted'
nl|'\n'
name|'mock_commit'
op|'.'
name|'side_effect'
...
op|'('
nl|'\n'
string|"'EXCEPTION in replication.Receiver while attempting commit of'"
op|','
nl|'\n'
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# hex content type delta encoded in extra message part'
nl|'\n'
name|'msg'
op|'='
string|"'%s %s t:%x,m:%x'"
...
newline|'\n'
nl|'\n'
comment|'# order of subparts does not matter'
nl|'\n'
name|'msg'
op|'='
string|"'%s %s m:%x,t:%x'"
...
newline|'\n'
nl|'\n'
comment|'# hex content type delta may be zero'
nl|'\n'
name|'msg'
op|'='
string|"'%s %s t:0,m:%x'"
