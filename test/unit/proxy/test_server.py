...
string|'"hash"'
op|':'
string|'"8681fb3ada2715c8754706ee5f23d4f8"'
op|','
nl|'\n'
string|'"last_modified"'
op|':'
...
string|'"hash"'
op|':'
string|'"419af6d362a14b7a789ba1c7e772bbae"'
op|','
nl|'\n'
string|'"last_modified"'
op|':'
...
string|'"hash"'
op|':'
string|'"e4c8f1de1c0855c7c2be33196d3c3537"'
op|','
nl|'\n'
string|'"last_modified"'
op|':'
...
string|"'GET'"
op|','
string|"'/a/d2/sub_manifest \\xe2\\x99\\xa1'"
op|','
op|'{'
op|'}'
op|']'
...
op|')'
newline|'\n'
comment|"# iterating over body will retrieve manifest and sub manifest's"
nl|'\n'
comment|'# objects'
nl|'\n'
name|'self'
...
newline|'\n'
nl|'\n'
DECL|member|test_GET_nested_manifest_slo_with_range
dedent|''
dedent|''
name|'def'
name|'test_GET_nested_manifest_slo_with_range'
op|'('
name|'self'
op|')'
op|':'
...
string|'"hash"'
op|':'
string|'"7b4b0ffa275d404bdc2fc6384916714f"'
op|','
comment|'# SubManifest1'
nl|'\n'
string|'"last_modified"'
op|':'
string|'"2012-11-08T04:05:37.866820"'
...
string|'"hash"'
op|':'
string|'"c20ad4d76fe97759aa27a0c99bff6710"'
op|','
comment|'# 12'
nl|'\n'
string|'"last_modified"'
...
string|'"hash"'
op|':'
string|'"e369853df766fa44e1ed0ff613f563bd"'
op|','
comment|'# 34'
nl|'\n'
string|'"last_modified"'
...
op|']'
op|','
comment|'# GET incomplete manifest'
nl|'\n'
name|'simplejson'
op|'.'
name|'dumps'
...
op|')'
op|','
comment|'# GET complete submanifest'
nl|'\n'
string|"'34'"
op|','
comment|'# GET subseg02'
nl|'\n'
string|"'Bb'"
op|')'
comment|'# GET seg02'
...
number|'206'
op|','
comment|'# GET incomplete listing'
nl|'\n'
number|'200'
op|','
comment|'# GET complete listing'
nl|'\n'
number|'200'
op|','
comment|'# GET complete sublisting'
nl|'\n'
number|'200'
op|','
comment|'# GET subSeg02'
...
op|']'
op|','
comment|'# for incomplete manifest'
nl|'\n'
op|'['
string|"'GET'"
op|','
...
op|')'
newline|'\n'
comment|'# Remember Request instance count, make sure the GC is run for pythons'
nl|'\n'
comment|'# without reference counting.'
nl|'\n'
name|'for'
name|'i'
name|'in'
...
op|')'
newline|'\n'
comment|'# Make sure the GC is run again for pythons without reference counting'
nl|'\n'
name|'for'
name|'i'
name|'in'
