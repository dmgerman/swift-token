...
op|':'
newline|'\n'
comment|'# figure out slope for function between this point and next'
nl|'\n'
indent|'                '
name|'next_size'
op|','
...
op|':'
newline|'\n'
comment|"# don't have to worry about scope here- this is the last"
nl|'\n'
...
nl|'\n'
nl|'\n'
DECL|member|_generate_key_rate_tuples
dedent|''
name|'def'
name|'_generate_key_rate_tuples'
op|'('
name|'self'
op|','
name|'account_name'
...
op|':'
newline|'\n'
comment|'#running_time_m > request_time_limit:'
nl|'\n'
indent|'            '
name|'need_to_sleep_m'
op|'='
...
op|':'
newline|'\n'
comment|'# make it accurate to 1% of clock accuracy'
nl|'\n'
...
op|':'
newline|'\n'
comment|'#TODO : David- get rid of the name thing- used for debugging'
nl|'\n'
indent|'        '
name|'req'
op|'='
