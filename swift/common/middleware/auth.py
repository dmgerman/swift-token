...
op|':'
newline|'\n'
comment|"# If we have no reseller prefix, we can't deny the"
nl|'\n'
comment|'# request just yet because another auth middleware'
nl|'\n'
comment|'# might be able to approve.'
nl|'\n'
indent|'                        '
name|'if'
...
op|':'
newline|'\n'
comment|"# If we don't have a reseller prefix we have no way of knowing"
nl|'\n'
comment|'# if we should be handling the request, so we only set'
nl|'\n'
comment|"# swift.authorize if it isn't set already (or we have a"
nl|'\n'
comment|'# reseller prefix that matches so we know we should handle the'
nl|'\n'
comment|'# request).'
nl|'\n'
indent|'                '
