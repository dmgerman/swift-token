...
op|':'
newline|'\n'
comment|'# preserve existing metadata, only content-type may be updated'
nl|'\n'
indent|'            '
name|'metadata'
op|'='
...
op|':'
newline|'\n'
comment|'# we have a new content-type, add to metadata and container update'
nl|'\n'
indent|'            '
...
op|':'
newline|'\n'
comment|'# send existing content-type with container update'
nl|'\n'
indent|'            '
name|'content_type_headers'
op|'='
...
op|':'
newline|'\n'
comment|"# only add to metadata if it's not the datafile content-type"
nl|'\n'
indent|'                '
name|'metadata'
op|'.'
...
op|':'
newline|'\n'
comment|'# For EC policy, send X-Object-Sysmeta-Ec-Etag which is same as the'
nl|'\n'
comment|'# X-Backend-Container-Update-Override-Etag value sent with the'
nl|'\n'
comment|'# original PUT. We have to send Etag (and size etc) with a POST'
nl|'\n'
comment|'# container update because the original PUT container update may'
nl|'\n'
comment|'# have failed or be in async_pending.'
nl|'\n'
indent|'            '
name|'update_etag'
op|'='
...
op|':'
newline|'\n'
comment|'# Current content-type is not from the datafile, but the datafile'
nl|'\n'
comment|'# content-type may have a swift_bytes param that was appended by'
nl|'\n'
comment|'# SLO and we must continue to send that with the container update.'
nl|'\n'
comment|'# Do this (rather than use a separate header) for backwards'
nl|'\n'
comment|"# compatibility because there may be 'legacy' container updates in"
nl|'\n'
comment|'# async pending that have content-types with swift_bytes params, so'
nl|'\n'
comment|'# we have to be able to handle those in container server anyway.'
nl|'\n'
indent|'            '
name|'_'
op|','
...
newline|'\n'
nl|'\n'
comment|'# object POST updates are PUT to the container server'
nl|'\n'
dedent|''
dedent|''
name|'self'
