...
newline|'\n'
nl|'\n'
comment|'# Due to the increased partition power, the partition each object is'
nl|'\n'
comment|'# assigned to has changed. If the old partition was X, it will now be'
nl|'\n'
comment|'# either located in 2*X or 2*X+1'
nl|'\n'
dedent|''
name|'self'
op|'.'
...
newline|'\n'
nl|'\n'
comment|'# Importantly, we expect the objects to be placed on the same nodes'
nl|'\n'
comment|'# after increasing the partition power'
nl|'\n'
name|'self'
op|'.'
name|'assertEqual'
