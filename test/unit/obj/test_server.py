...
op|':'
newline|'\n'
comment|'# Test that POST does call container_update and returns success'
nl|'\n'
comment|'# whether update to container server succeeds or fails'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_test_POST_container_updates
dedent|''
name|'def'
name|'_test_POST_container_updates'
op|'('
name|'self'
op|','
name|'policy'
...
op|':'
newline|'\n'
comment|'# Test that POST requests result in correct calls to container_update'
nl|'\n'
indent|'        '
name|'ts_iter'
op|'='
...
newline|'\n'
nl|'\n'
DECL|function|mock_container_update
name|'def'
name|'mock_container_update'
op|'('
name|'ctlr'
op|','
name|'op'
...
string|"'Content-Type'"
op|':'
string|"'application/octet-stream;swift_bytes=123456789'"
op|','
nl|'\n'
string|"'Content-Length'"
op|':'
...
op|','
nl|'\n'
string|"'X-Backend-Storage-Policy'"
op|':'
name|'int'
op|'('
name|'policy'
...
newline|'\n'
nl|'\n'
comment|'# POST with no metadata newer than the data should return 409,'
nl|'\n'
comment|'# container update not expected'
nl|'\n'
name|'calls_made'
op|'='
op|'['
...
newline|'\n'
nl|'\n'
comment|'# POST with newer metadata returns success and container update'
nl|'\n'
comment|'# is expected'
nl|'\n'
name|'calls_made'
...
newline|'\n'
nl|'\n'
comment|'# POST with no metadata newer than existing metadata should return'
nl|'\n'
comment|'# 409, container update not expected'
nl|'\n'
name|'calls_made'
op|'='
op|'['
...
newline|'\n'
nl|'\n'
comment|'# POST with newer content-type but older metadata returns success'
nl|'\n'
comment|'# and container update is expected newer content-type should have'
nl|'\n'
comment|'# existing swift_bytes appended'
nl|'\n'
name|'calls_made'
op|'='
op|'['
...
string|"'x-content-type'"
op|':'
string|"'text/plain;swift_bytes=123456789'"
op|','
nl|'\n'
string|"'x-timestamp'"
op|':'
...
newline|'\n'
nl|'\n'
comment|'# POST with older content-type but newer metadata returns success'
nl|'\n'
comment|'# and container update is expected'
nl|'\n'
name|'calls_made'
op|'='
op|'['
...
newline|'\n'
nl|'\n'
comment|'# POST with same-time content-type and metadata returns 409'
nl|'\n'
comment|'# and no container update is expected'
nl|'\n'
name|'calls_made'
op|'='
op|'['
...
newline|'\n'
nl|'\n'
comment|'# POST with implicit newer content-type but older metadata'
nl|'\n'
comment|'# returns success and container update is expected,'
nl|'\n'
comment|'# update reports existing metadata timestamp'
nl|'\n'
name|'calls_made'
op|'='
op|'['
...
string|"'x-content-type'"
op|':'
string|"'text/newer;swift_bytes=123456789'"
op|','
nl|'\n'
string|"'x-timestamp'"
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_POST_container_updates_with_replication_policy
dedent|''
name|'def'
name|'test_POST_container_updates_with_replication_policy'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_POST_container_updates_with_EC_policy
dedent|''
name|'def'
name|'test_POST_container_updates_with_EC_policy'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|_test_PUT_then_POST_async_pendings
dedent|''
name|'def'
name|'_test_PUT_then_POST_async_pendings'
op|'('
name|'self'
op|','
name|'policy'
...
op|':'
newline|'\n'
comment|'# Test that PUT and POST requests result in distinct async pending'
nl|'\n'
comment|'# files when sync container update fails.'
nl|'\n'
...
name|'patch'
op|'('
string|"'swift.obj.server.http_connect'"
op|','
name|'fake_http_connect'
op|')'
op|','
...
op|','
nl|'\n'
string|"'Expected %s to be a file but it is not.'"
nl|'\n'
op|'%'
name|'async_pending_file_put'
op|')'
newline|'\n'
name|'expected_put_headers'
op|'='
op|'{'
nl|'\n'
string|"'Referer'"
...
name|'None'
newline|'\n'
comment|'# check async pending file for PUT is still intact'
nl|'\n'
name|'self'
op|'.'
name|'assertDictEqual'
...
newline|'\n'
nl|'\n'
comment|'# check distinct async pending file for POST'
nl|'\n'
name|'async_pending_file_post'
op|'='
name|'os'
op|'.'
name|'path'
...
op|')'
newline|'\n'
name|'expected_post_headers'
op|'='
op|'{'
nl|'\n'
string|"'Referer'"
op|':'
string|"'POST http://localhost/sda1/p/a/c/o'"
op|','
nl|'\n'
string|"'X-Trans-Id'"
op|':'
...
string|"'X-Content-Type'"
op|':'
string|"'application/other;swift_bytes=123456789'"
op|','
nl|'\n'
string|"'X-Size'"
op|':'
...
newline|'\n'
nl|'\n'
comment|'# verify that only the POST (most recent) async update gets sent by the'
nl|'\n'
comment|'# object updater, and that both update files are deleted'
nl|'\n'
name|'with'
name|'mock'
op|'.'
...
op|'('
nl|'\n'
string|"'swift.obj.updater.ObjectUpdater.object_update'"
op|')'
name|'as'
name|'mock_update'
op|','
...
name|'patch'
op|'('
string|"'swift.obj.updater.dump_recon_cache'"
op|')'
op|':'
newline|'\n'
indent|'            '
...
newline|'\n'
nl|'\n'
DECL|member|test_PUT_then_POST_async_pendings_with_repl_policy
dedent|''
name|'def'
name|'test_PUT_then_POST_async_pendings_with_repl_policy'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_PUT_then_POST_async_pendings_with_EC_policy
dedent|''
name|'def'
name|'test_PUT_then_POST_async_pendings_with_EC_policy'
op|'('
name|'self'
op|')'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|test_POST_then_fetch_content_type
dedent|''
name|'def'
name|'test_POST_then_fetch_content_type'
op|'('
name|'self'
op|')'
op|':'
newline|'\n'
comment|'# check that content_type is updated by a POST'
nl|'\n'
indent|'        '
name|'timestamp1'
op|'='
...
newline|'\n'
nl|'\n'
comment|'# .meta file metadata should have updated content-type'
nl|'\n'
name|'metafile_name'
op|'='
name|'encode_timestamps'
