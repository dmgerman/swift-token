...
number|'2'
newline|'\n'
DECL|variable|CONNECT_ATTEMPTS
name|'CONNECT_ATTEMPTS'
op|'='
number|'4'
newline|'\n'
DECL|variable|PENDING_COMMIT_TIMEOUT
name|'PENDING_COMMIT_TIMEOUT'
op|'='
number|'900'
newline|'\n'
DECL|variable|AUTOCHECKPOINT
name|'AUTOCHECKPOINT'
op|'='
number|'8192'
newline|'\n'
...
newline|'\n'
comment|'# retry logic to address:'
nl|'\n'
comment|'# http://www.mail-archive.com/sqlite-users@sqlite.org/msg57092.html'
nl|'\n'
name|'for'
name|'attempt'
name|'in'
...
name|'execute'
op|'('
string|"'PRAGMA wal_autocheckpoint = %s'"
op|'%'
name|'AUTOCHECKPOINT'
op|')'
newline|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|_get_db_version
dedent|''
name|'def'
name|'_get_db_version'
op|'('
name|'self'
op|','
name|'conn'
...
newline|'\n'
nl|'\n'
DECL|member|get_random_objects
dedent|''
dedent|''
name|'def'
...
name|'query'
op|'+='
string|"' +deleted = 0 ORDER BY name LIMIT ?'"
newline|'\n'
dedent|''
name|'else'
op|':'
...
newline|'\n'
nl|'\n'
DECL|member|get_random_containers
dedent|''
dedent|''
name|'def'
