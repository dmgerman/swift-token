...
op|':'
newline|'\n'
comment|"# XXX with jerasure this doesn't work if we need to rebuild a"
nl|'\n'
comment|'# parity fragment, and not all data fragments are available'
nl|'\n'
comment|'# segment = policy.pyeclib_driver.reconstruct('
nl|'\n'
comment|'#     fragment_payload, [frag_index])[0]'
nl|'\n'
nl|'\n'
comment|"# for safety until pyeclib 1.0.7 we'll just use decode and encode"
nl|'\n'
indent|'        '
name|'segment'
op|'='
