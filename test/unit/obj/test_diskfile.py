...
name|'fail'
op|'('
string|'"Expected DiskFileQuarantined, didn\'t get it"'
op|')'
newline|'\n'
nl|'\n'
...
name|'fail'
op|'('
string|'"Expected DiskFileDeviceUnavailable exception"'
op|')'
newline|'\n'
nl|'\n'
...
newline|'\n'
nl|'\n'
DECL|member|test_error_in_hashdir_cleanup_listdir
dedent|''
dedent|''
name|'def'
name|'test_error_in_hashdir_cleanup_listdir'
op|'('
name|'self'
op|')'
op|':'
