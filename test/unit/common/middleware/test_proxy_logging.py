...
newline|'\n'
nl|'\n'
DECL|member|test_no_content_length_no_transfer_encoding_with_str_body
dedent|''
name|'def'
name|'test_no_content_length_no_transfer_encoding_with_str_body'
op|'('
name|'self'
op|')'
op|':'
...
op|')'
newline|'\n'
comment|'# Python 2.7 can have assertRaises act as a context manager, but python'
nl|'\n'
comment|"# 2.6 can't.  So there's this."
nl|'\n'
name|'try'
op|':'
newline|'\n'
...
op|'('
nl|'\n'
string|'"WSGI [proxy-logging]: No content-length or transfer-encoding "'
nl|'\n'
string|'"header sent and there is content! \'l\'"'
op|','
name|'str'
op|'('
name|'e'
