...
newline|'\n'
nl|'\n'
comment|"# We'll either parse the all-in-one-string format or the --options format,"
nl|'\n'
...
indent|'                '
name|'print'
string|"'Invalid weight value (must be positive): %s'"
op|'%'
name|'weightstr'
newline|'\n'
name|'print'
...
string|"'%d devices, %.02f balance, %.02f dispersion'"
op|'%'
op|'('
nl|'\n'
name|'builder'
...
newline|'\n'
name|'print'
string|"'The overload factor is %.6f'"
op|'%'
name|'builder'
op|'.'
name|'overload'
...
name|'print'
op|'('
string|'"Search value \\"%s\\" matched 0 devices.\\n"'
nl|'\n'
string|'"The on-disk ring builder is unchanged.\\n"'
nl|'\n'
op|'%'
...
nl|'\n'
string|"'      You may want adjust some device weights, increase\\n'"
nl|'\n'
