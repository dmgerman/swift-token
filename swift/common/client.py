...
newline|'\n'
indent|'    '
string|'"""Takes a request in json parse it and return in json"""'
newline|'\n'
name|'kwargs'
op|'.'
name|'setdefault'
...
name|'ClientException'
op|'('
string|'"There is no object-store endpoint "'
string|'"on this auth server."'
op|')'
newline|'\n'
dedent|''
dedent|''
...
name|'ClientException'
op|'('
string|'"Error while getting answers from auth server"'
op|')'
newline|'\n'
nl|'\n'
dedent|''
...
name|'ClientException'
op|'('
string|"'Unknown auth_version %s specified.'"
op|'%'
nl|'\n'
name|'auth_version'
op|')'
...
newline|'\n'
indent|'        '
string|'"""Wrapper for :func:`post_account`"""'
newline|'\n'
name|'return'
name|'self'
op|'.'
...
newline|'\n'
indent|'        '
string|'"""Wrapper for :func:`post_container`"""'
newline|'\n'
name|'return'
name|'self'
op|'.'
...
name|'ClientException'
op|'('
string|"'put_object(%r, %r, ...) failure and no '"
nl|'\n'
string|"'ability to reset contents for reupload.'"
op|'%'
op|'('
name|'container'
op|','
