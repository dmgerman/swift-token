...
newline|'\n'
nl|'\n'
comment|'# TODO(seriously, anyone can do this): make this use the /info API once'
nl|'\n'
comment|'# it lands, both for detection of SLO and for minimum segment size'
nl|'\n'
dedent|''
name|'if'
name|'cls'
...
op|':'
newline|'\n'
comment|"# If SLO is enabled, this'll raise an error since"
nl|'\n'
comment|'# X-Static-Large-Object is a reserved header.'
nl|'\n'
comment|'#'
nl|'\n'
comment|'# If SLO is not enabled, then this will get the usual 2xx'
nl|'\n'
comment|'# response.'
nl|'\n'
indent|'                '
