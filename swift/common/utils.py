...
name|'return'
newline|'\n'
comment|'## fallocate is prefered because we need the on-disk size to match'
nl|'\n'
...
name|'warn'
op|'('
string|'"posix_fadvise64(%s, %s, %s, 4) -> %s"'
nl|'\n'
op|'%'
op|'('
name|'fd'
...
indent|'            '
name|'pass'
comment|'# may have not actually opened the file'
newline|'\n'
dedent|''
name|'if'
name|'unlink'
